...
krabkrab system heartbeat last
krabkrab logs --follow
krabkrab config get agents.defaults.heartbeat
krabkrab channels status --probe
```
...
```bash
krabkrab config get agents.defaults.heartbeat.activeHours
krabkrab config get agents.defaults.heartbeat.activeHours.timezone
krabkrab config get agents.defaults.userTimezone || echo "agents.defaults.userTimezone not set"
krabkrab cron list
krabkrab logs --follow
```
