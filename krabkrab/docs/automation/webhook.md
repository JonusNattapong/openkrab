...
read_when:
  ...
  - Wiring external systems into KrabKrab
title: "Webhooks"
---
...
- `hooks.transformsDir` + `transform.module` loads a JS/TS module for custom logic.
  - `hooks.transformsDir` (if set) must stay within the transforms root under your KrabKrab config directory (typically `~/.krabkrab/hooks/transforms`).
...
- `krabkrab webhooks gmail setup` writes `hooks.gmail` config for `krabkrab webhooks gmail run`.
