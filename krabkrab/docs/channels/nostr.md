...
read_when:
  - You want KrabKrab to receive DMs via Nostr
...
Nostr is a decentralized protocol for social networking. This channel enables KrabKrab to receive and respond to encrypted direct messages (DMs) via NIP-04.

## Install (on demand)

### Onboarding (recommended)

- The onboarding wizard (`krabkrab onboard`) and `krabkrab channels add` list optional channel plugins.
...
```bash
krabkrab plugins install @krabkrab/nostr
```

Use a local checkout (dev workflows):

```bash
krabkrab plugins install --link <path-to-krabkrab>/extensions/nostr
```
...
```json
{
  "channels": {
    "nostr": {
      ...
      "profile": {
        "name": "krabkrab",
        "displayName": "KrabKrab",
        "about": "Personal assistant DM bot",
        "picture": "https://example.com/avatar.png",
        "banner": "https://example.com/banner.png",
        "website": "https://example.com",
        "nip05": "krabkrab@example.com",
        "lud16": "krabkrab@example.com"
      }
    }
  }
}
