...
- Install via CLI: `krabkrab plugins install @krabkrab/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `krabkrab plugins install ./extensions/zalo`
   - From npm (if published): `krabkrab plugins install @krabkrab/zalo`
...
- Approve via:
  - `krabkrab pairing list zalo`
  - `krabkrab pairing approve zalo <CODE>`
...
- Example: `krabkrab message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `krabkrab channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `krabkrab logs --follow`
