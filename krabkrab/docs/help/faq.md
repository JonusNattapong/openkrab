---
summary: "Frequently asked questions about KrabKrab setup, configuration, and usage"
title: "FAQ"
---
...
- [Quick start and first-run setup]
  ...
  - [What's the recommended way to install and set up KrabKrab?](#whats-the-recommended-way-to-install-and-set-up-krabkrab)
  ...
  - [I can't access docs.krabkrab.ai (SSL error). What now?](#i-cant-access-docskrabkrabai-ssl-error-what-now)
  - [What's the difference between stable and beta?](#whats-the-difference-between-stable-and-beta)
  - [How do I install the beta version, and what's the difference between beta and dev?](#how-do-i-install-the-beta-version-and-whats-the-difference-between-beta-and-dev)
  - [How do I try the latest bits?](#how-do-i-try-the-latest-bits)
  - [How long does install and onboarding usually take?](#how-long-does-install-and-onboarding-usually-take)
  - [Installer stuck? How do I get more feedback?](#installer-stuck-how-do-i-get-more-feedback)
  - [Windows install says git not found or krabkrab not recognized](#windows-install-says-git-not-found-or-krabkrab-not-recognized)
  - [The docs didn't answer my question - how do I get a better answer?](#the-docs-didnt-answer-my-question-how-do-i-get-a-better-answer)
  - [How do I install KrabKrab on Linux?](#how-do-i-install-krabkrab-on-linux)
  - [How do I install KrabKrab on a VPS?](#how-do-i-install-krabkrab-on-a-vps)
  - [Where are the cloud/VPS install guides?](#where-are-the-cloudvps-install-guides)
  - [Can I ask KrabKrab to update itself?](#can-i-ask-krabkrab-to-update-itself)
  ...
  - [If I buy a Mac mini to run KrabKrab, can I connect it to my MacBook Pro?](#if-i-buy-a-mac-mini-to-run-krabkrab-can-i-connect-it-to-my-macbook-pro)
  - [Can I use Bun?](#can-i-use-bun)
  - [Telegram: what goes in `allowFrom`?](#telegram-what-goes-in-allowfrom)
  - [Can multiple people use one WhatsApp number with different KrabKrab instances?](#can-multiple-people-use-one-whatsapp-number-with-different-krabkrab-instances)
  - [Can I run a "fast chat" agent and an "Opus for coding" agent?](#can-i-run-a-fast-chat-agent-and-an-opus-for-coding-agent)
  - [Does Homebrew work on Linux?](#does-homebrew-work-on-linux)
  - [What's the difference between the hackable (git) install and npm install?](#whats-the-difference-between-the-hackable-git-install-and-npm-install)
  - [Can I switch between npm and git installs later?](#can-i-switch-between-npm-and-git-installs-later)
  - [Should I run the Gateway on my laptop or a VPS?](#should-i-run-the-gateway-on-my-laptop-or-a-vps)
  - [How important is it to run KrabKrab on a dedicated machine?](#how-important-is-it-to-run-krabkrab-on-a-dedicated-machine)
  - [What are the minimum VPS requirements and recommended OS?](#what-are-the-minimum-vps-requirements-and-recommended-os)
  - [Can I run KrabKrab in a VM and what are the requirements](#can-i-run-krabkrab-in-a-vm-and-what-are-the-requirements)
- [What is KrabKrab?](#what-is-krabkrab)
  - [What is KrabKrab, in one paragraph?](#what-is-krabkrab-in-one-paragraph)
  - [What's the value proposition?](#whats-the-value-proposition)
  - [I just set it up what should I do first](#i-just-set-it-up-what-should-i-do-first)
  - [What are the top five everyday use cases for KrabKrab](#what-are-the-top-five-everyday-use-cases-for-krabkrab)
  - [Can KrabKrab help with lead gen outreach ads and blogs for a SaaS](#can-krabkrab-help-with-lead-gen-outreach-ads-and-blogs-for-a-saas)
...
- [Skills and automation](#skills-and-automation)
  ...
  - [Can KrabKrab run tasks on a schedule or continuously in the background?](#can-krabkrab-run-tasks-on-a-schedule-or-continuously-in-the-background)
...
- [Where things live on disk](#where-things-live-on-disk)
  - [Is all data used with KrabKrab saved locally?](#is-all-data-used-with-krabkrab-saved-locally)
  - [Where does KrabKrab store its data?](#where-does-krabkrab-store-its-data)
  - [Where should AGENTS.md / SOUL.md / USER.md / MEMORY.md live?](#where-should-agentsmd-soulmd-usermd-memorymd-live)
  - [What's the recommended backup strategy?](#whats-the-recommended-backup-strategy)
  - [How do I completely uninstall KrabKrab?](#how-do-i-completely-uninstall-krabkrab)
...
- [Config basics](#config-basics)
  ...
  - [Can the KrabKrab browser run headless?](#can-the-krabkrab-browser-run-headless)
...
- [Remote gateways and nodes](#remote-gateways-and-nodes)
  ...
  - [Can two KrabKrab instances talk to each other (local + VPS)?](#can-two-krabkrab-instances-talk-to-each-other-local-vps)
...
- [Env vars and .env loading](#env-vars-and-env-loading)
  - [How does KrabKrab load environment variables?](#how-does-krabkrab-load-environment-variables)
...
- [Sessions and multiple chats](#sessions-and-multiple-chats)
  ...
  - [Is there a way to make a team of KrabKrab instances one CEO and many agents](#is-there-a-way-to-make-a-team-of-krabkrab-instances-one-ceo-and-many-agents)
  - [Why did context get truncated mid-task? How do I prevent it?](#why-did-context-get-truncated-midtask-how-do-i-prevent-it)
  - [How do I completely reset KrabKrab but keep it installed?](#how-do-i-completely-reset-krabkrab-but-keep-it-installed)
  ...
  - [Why doesn't KrabKrab reply in a group?](#why-doesnt-krabkrab-reply-in-a-group)
...
- [Models: defaults, selection, aliases, switching](#models-defaults-selection-aliases-switching)
  ...
  - [What do KrabKrab, Flawd, and Krill use for models?](#what-do-krabkrab-flawd-and-krill-use-for-models)
...
- [Gateway: ports, "already running", and remote mode](#gateway-ports-already-running-and-remote-mode)
  ...
  - [Why does `krabkrab gateway status` say `Runtime: running` but `RPC probe: failed`?](#why-does-krabkrab-gateway-status-say-runtime-running-but-rpc-probe-failed)
  - [Why does `krabkrab gateway status` show `Config (cli)` and `Config (service)` different?](#why-does-krabkrab-gateway-status-show-config-cli-and-config-service-different)
  - [What does "another gateway instance is already listening" mean?](#what-does-another-gateway-instance-is-already-listening-mean)
  - [How do I run KrabKrab in remote mode (client connects to a Gateway elsewhere)?](#how-do-i-run-krabkrab-in-remote-mode-client-connects-to-a-gateway-elsewhere)
...
- [Logging and debugging](#logging-and-debugging)
  ...
  - [I closed my terminal on Windows - how do I restart KrabKrab?](#i-closed-my-terminal-on-windows-how-do-i-restart-krabkrab)
  ...
  - [ELI5: `krabkrab gateway restart` vs `krabkrab gateway`](#eli5-krabkrab-gateway-restart-vs-krabkrab-gateway)
  - [What's the fastest way to get more details when something fails?](#whats-the-fastest-way-to-get-more-details-when-something-fails)
- [Media and attachments](#media-and-attachments)
  - [My skill generated an image/PDF, but nothing was sent](#my-skill-generated-an-imagepdf-but-nothing-was-sent)
- [Security and access control](#security-and-access-control)
  - [Is it safe to expose KrabKrab to inbound DMs?](#is-it-safe-to-expose-krabkrab-to-inbound-dms)
...
7. **Gateway snapshot**
   ...
   krabkrab health --verbose   # shows the target URL + config path on errors
   ```
...
This installs KrabKrab **from a git checkout**, so the agent can read the code + docs and
...
[https://github.com/krabkrab/krabkrab/issues](https://github.com/krabkrab/krabkrab/issues)
[https://github.com/krabkrab/krabkrab/pulls](https://github.com/krabkrab/krabkrab/pulls)
...
- `krabkrab status`: quick snapshot of gateway/agent health + basic config.
- `krabkrab models status`: checks provider auth + model availability.
- `krabkrab doctor`: validates and repairs common config/state issues.

Other useful CLI checks: `krabkrab status --all`, `krabkrab logs --follow`,
`krabkrab gateway status`, `krabkrab health --verbose`.

Quick debug loop: [First 60 seconds if something's broken](#first-60-seconds-if-somethings-broken).
Install docs: [Install](/install), [Installer flags](/install/installer), [Updating](/install/updating).

### What's the recommended way to install and set up KrabKrab
...
If you don't have a global install yet, run it via `pnpm krabkrab onboard`.
...
- If it asks for auth, paste the token from `gateway.auth.token` (or `krabkrab_GATEWAY_TOKEN`) into Control UI settings.
- Retrieve it from the gateway host: `krabkrab config get gateway.auth.token` (or generate one: `krabkrab doctor --generate-gateway-token`).

**Not on localhost:**

- **Tailscale Serve** (recommended): keep bind loopback, run `krabkrab gateway --tailscale serve`, open `https://<magicdns>/`. If `gateway.auth.allowTailscale` is `true`, identity headers satisfy auth (no token).
- **Tailnet bind**: run `krabkrab gateway --bind tailnet --token "<token>"`, open `http://<tailscale-ip>:18789/`, paste token in dashboard settings.
...
1. Install KrabKrab on the new machine.
2. Copy `$krabkrab_STATE_DIR` (default: `~/.krabkrab`) from the old machine.
3. Copy your workspace (default: `~/.krabkrab/workspace`).
4. Run `krabkrab doctor` and restart the Gateway service.
...
under `~/.krabkrab/` (for example `~/.krabkrab/agents/<agentId>/sessions/`).

Related: [Migrating](/install/migrating), [Where things live on disk](/help/faq#where-does-krabkrab-store-its-data),
...
[https://github.com/krabkrab/krabkrab/blob/main/CHANGELOG.md](https://github.com/krabkrab/krabkrab/blob/main/CHANGELOG.md)

Newest entries are at the top. If the top section is marked **Unreleased**, the next dated
section is the latest shipped version. Entries are grouped by **Highlights**, **Changes**, and
**Fixes** (plus docs/other sections when needed).

### I cant access docs.krabkrab.ai SSL error What now

Some Comcast/Xfinity connections incorrectly block `docs.krabkrab.ai` via Xfinity
Advanced Security. Disable it or allowlist `docs.krabkrab.ai`, then retry. More
detail: [Troubleshooting](/help/troubleshooting#docskrabkrabai-shows-an-ssl-error-comcastxfinity).
Please help us unblock it by reporting here: [https://spa.xfinity.com/check_url_status](https://spa.xfinity.com/check_url_status).

If you still can't reach the site, the docs are mirrored on GitHub:
[https://github.com/krabkrab/krabkrab/tree/main/docs](https://github.com/krabkrab/krabkrab/tree/main/docs)
...
[https://krabkrab.ai/install.ps1](https://krabkrab.ai/install.ps1)
...
Set-PSDebug -Trace 1
& ([scriptblock]::Create((iwr -useb https://krabkrab.ai/install.ps1))) -NoOnboard
Set-PSDebug -Trace 0
```

More options: [Installer flags](/install/installer).

### Windows install says git not found or krabkrab not recognized
...
**2) krabkrab is not recognized after install**
...
### How do I install KrabKrab on Linux
...
### How do I install KrabKrab on a VPS
...
### Can I ask KrabKrab to update itself
...
`krabkrab onboard` is the recommended setup path. In **local mode** it walks you through:
...
No. You can run KrabKrab with **API keys** (Anthropic/OpenAI/others) or with
...
`claude setup-token` generates a **token string** via the Claude Code CLI (it is not available in the web console). You can run it on **any machine**. Choose **Anthropic token (paste setup-token)** in the wizard or paste it with `krabkrab models auth paste-token --provider anthropic`. The token is stored as an auth profile for the **anthropic** provider and used like an API key (no auto-refresh). More detail: [OAuth](/concepts/oauth).
...
Copy the token it prints, then choose **Anthropic token (paste setup-token)** in the wizard. If you want to run it on the gateway host, use `krabkrab models auth setup-token --provider anthropic`. If you ran `claude setup-token` elsewhere, paste it on the gateway host with `krabkrab models auth paste-token --provider anthropic`. See [Anthropic](/providers/anthropic).

### Do you support Claude subscription auth (Claude Pro or Max)

Yes - via **setup-token**. KrabKrab no longer reuses Claude Code CLI OAuth tokens; use a setup-token or an Anthropic API key. Generate the token anywhere and paste it on the gateway host. See [Anthropic](/providers/anthropic) and [OAuth](/concepts/oauth).
...
Tip: set a **fallback model** so KrabKrab can keep replying while a provider is rate-limited.
...
KrabKrab supports **OpenAI Code (Codex)** via OAuth (ChatGPT sign-in). The wizard can run the OAuth flow and will set the default model to `openai-codex/gpt-5.3-codex` when appropriate. See [Model providers](/concepts/model-providers) and [Wizard](/start/wizard).

### Do you support OpenAI subscription auth Codex OAuth

Yes. KrabKrab fully supports **OpenAI Code (Codex) subscription OAuth**. The onboarding wizard
...
Gemini CLI uses a **plugin auth flow**, not a client id or secret in `krabkrab.json`.

Steps:

1. Enable the plugin: `krabkrab plugins enable google-gemini-cli-auth`
2. Login: `krabkrab models auth login --provider google-gemini-cli --set-default`

This stores OAuth tokens in auth profiles on the gateway host. Details: [Model providers](/concepts/model-providers).

### Is a local model OK for casual chats

Usually no. KrabKrab needs large context + strong safety; small cards truncate and leak. If you must, run the **largest** MiniMax M2.1 build you can locally (LM Studio) and see [/gateway/local-models](/gateway/local-models). Smaller/quantized models increase prompt-injection risk - see [Security](/gateway/security).
...
No. KrabKrab runs on macOS or Linux (Windows via WSL2). A Mac mini is optional - some people
...
### If I buy a Mac mini to run KrabKrab can I connect it to my MacBook Pro
...
- Use `krabkrab nodes status` / `krabkrab nodes list` to see it.
...
The onboarding wizard accepts `@username` input and resolves it to a numeric ID, but KrabKrab authorization uses numeric IDs only.

Safer (no third-party bot):

- DM your bot, then run `krabkrab logs --follow` and read `from.id`.
...
### Can multiple people use one WhatsApp number with different KrabKrab instances
...
If you run KrabKrab via systemd, ensure the service PATH includes `/home/linuxbrew/.linuxbrew/bin` (or your brew prefix) so `brew`-installed tools resolve in non-login shells.
...
This **does not delete your data** - it only changes the KrabKrab code install. Your state
(`~/.krabkrab`) and workspace (`~/.krabkrab/workspace`) stay untouched.
...
**KrabKrab-specific note:** WhatsApp/Telegram/Slack/Mattermost (plugin)/Discord all work fine from a VPS. The only real trade-off is **headless browser** vs a visible window. See [Browser](/tools/browser).

**Recommended default:** VPS if you had gateway disconnects before. Local is great when you're actively using the Mac and want local file access or UI automation with a visible browser.

### How important is it to run KrabKrab on a dedicated machine
...
KrabKrab is lightweight. For a basic Gateway + one chat channel:
...
### Can I run KrabKrab in a VM and what are the requirements
...
### What is KrabKrab in one paragraph

KrabKrab is a personal AI assistant you run on your own devices. It replies on the messaging surfaces you already use (WhatsApp, Telegram, Slack, Mattermost (plugin), Discord, Google Chat, Signal, iMessage, WebChat) and can also do voice + a live Canvas on supported platforms. The **Gateway** is the always-on control plane; the assistant is the product.

### What's the value proposition

KrabKrab is not "just a Claude wrapper." It's a **local-first control plane** that lets you run a
...
### What are the top five everyday use cases for KrabKrab
...
### Can KrabKrab help with lead gen outreach ads and blogs for a SaaS
...
KrabKrab draft and you approve.

Docs: [Security](/gateway/security).

### What are the advantages vs Claude Code for web development

KrabKrab is a **personal assistant** and coordination layer, not an IDE replacement. Use
Claude Code or Codex for the fastest direct coding loop inside a repo. Use KrabKrab when you
...
Showcase: [https://krabkrab.ai/showcase](https://krabkrab.ai/showcase)

## Skills and automation

### How do I customize skills without keeping the repo dirty

Use managed overrides instead of editing the repo copy. Put your changes in `~/.krabkrab/skills/<name>/SKILL.md` (or add a folder via `skills.load.extraDirs` in `~/.krabkrab/krabkrab.json`). Precedence is `<workspace>/skills` > `~/.krabkrab/skills` > bundled, so managed overrides win without touching git. Only upstream-worthy edits should live in the repo and go out as PRs.

### Can I load skills from a custom folder

Yes. Add extra directories via `skills.load.extraDirs` in `~/.krabkrab/krabkrab.json` (lowest precedence). Default precedence remains: `<workspace>/skills` â†’ `~/.krabkrab/skills` â†’ bundled â†’ `skills.load.extraDirs`. `clawhub` installs into `./skills` by default, which KrabKrab treats as `<workspace>/skills`.
...
- Confirm cron is enabled (`cron.enabled`) and `krabkrab_SKIP_CRON` is not set.
...
### Can KrabKrab run tasks on a schedule or continuously in the background
...
Not directly. macOS skills are gated by `metadata.krabkrab.os` plus required binaries, and skills only appear in the system prompt when they are eligible on the **Gateway host**. On Linux, `darwin`-only skills (like `apple-notes`, `apple-reminders`, `things-mac`) will not load unless you override the gating.

You have three supported patterns:

**Option A - run the Gateway on a Mac (simplest).**
Run the Gateway where the macOS binaries exist, then connect from Linux in [remote mode](#how-do-i-run-krabkrab-in-remote-mode-client-connects-to-a-gateway-elsewhere) or over Tailscale. The skills load normally because the Gateway host is macOS.

**Option B - use a macOS node (no SSH).**
Run the Gateway on Linux, pair a macOS node (menubar app), and set **Node Run Commands** to "Always Ask" or "Always Allow" on the Mac. KrabKrab can treat macOS-only skills as eligible when the required binaries exist on the node. The agent runs those skills via the `nodes` tool. If you choose "Always Ask", approving "Always Allow" in the prompt adds that command to the allowlist.
...
3. Override the skill metadata (workspace or `~/.krabkrab/skills`) to allow Linux:

   ```markdown
   ---
   name: apple-notes
   description: Manage Apple Notes via the memo CLI on macOS.
   metadata: { "krabkrab": { "os": ["darwin", "linux"], "requires": { "bins": ["memo"] } } }
   ---
   ```
...
ClawHub installs into `./skills` under your current directory (or falls back to your configured KrabKrab workspace); KrabKrab treats that as `<workspace>/skills` on the next session. For shared skills across agents, place them in `~/.krabkrab/skills/<name>/SKILL.md`. Some skills expect binaries installed via Homebrew; on Linux that means Linuxbrew (see the Homebrew Linux FAQ entry above). See [Skills](/tools/skills) and [ClawHub](/tools/clawhub).
...
- Persist `/home/node` with `krabkrab_HOME_VOLUME` so caches survive.
- Bake system deps into the image with `krabkrab_DOCKER_APT_PACKAGES`.
...
KrabKrab memory is just Markdown files in the agent workspace:

- Daily notes in `memory/YYYY-MM-DD.md`
- Curated long-term notes in `MEMORY.md` (main/private sessions only)

KrabKrab also runs a **silent pre-compaction memory flush** to remind the model
...
If you don't set a provider explicitly, KrabKrab auto-selects a provider when it
can resolve an API key (auth profiles, `models.providers.*.apiKey`, or env vars).
It prefers OpenAI if an OpenAI key resolves, otherwise Gemini if a Gemini key
resolves. If neither key is available, memory search stays disabled until you
configure it. If you have a local model path configured and present, KrabKrab
prefers `local`.
...
### Is all data used with KrabKrab saved locally

No - **KrabKrab's state is local**, but **external services still see what you send them**.

- **Local by default:** sessions, memory files, config, and workspace live on the Gateway host
  (`~/.krabkrab` + your workspace directory).
...
### Where does KrabKrab store its data

Everything lives under `$krabkrab_STATE_DIR` (default: `~/.krabkrab`):

| Path                                                            | Purpose                                                      |
| --------------------------------------------------------------- | ------------------------------------------------------------ |
| `$krabkrab_STATE_DIR/krabkrab.json`                             | Main config (JSON5)                                          |
| `$krabkrab_STATE_DIR/credentials/oauth.json`                    | Legacy OAuth import (copied into auth profiles on first use) |
| `$krabkrab_STATE_DIR/agents/<agentId>/agent/auth-profiles.json` | Auth profiles (OAuth + API keys)                             |
| `$krabkrab_STATE_DIR/agents/<agentId>/agent/auth.json`          | Runtime auth cache (managed automatically)                   |
| `$krabkrab_STATE_DIR/credentials/`                              | Provider state (e.g. `whatsapp/<accountId>/creds.json`)      |
| `$krabkrab_STATE_DIR/agents/`                                   | Per-agent state (agentDir + sessions)                        |
| `$krabkrab_STATE_DIR/agents/<agentId>/sessions/`                | Conversation history & state (per agent)                     |
| `$krabkrab_STATE_DIR/agents/<agentId>/sessions/sessions.json`   | Session metadata (per agent)                                 |

Legacy single-agent path: `~/.krabkrab/agent/*` (migrated by `krabkrab doctor`).

Your **workspace** (AGENTS.md, memory files, skills, etc.) is separate and configured via `agents.defaults.workspace` (default: `~/.krabkrab/workspace`).

### Where should AGENTSmd SOULmd USERmd MEMORYmd live

These files live in the **agent workspace**, not `~/.krabkrab`.

- **Workspace (per agent)**: `AGENTS.md`, `SOUL.md`, `IDENTITY.md`, `USER.md`,
  `MEMORY.md` (or `memory.md`), `memory/YYYY-MM-DD.md`, optional `HEARTBEAT.md`.
- **State dir (`~/.krabkrab`)**: config, credentials, auth profiles, sessions, logs,
  and shared skills (`~/.krabkrab/skills`).

Default workspace is `~/.krabkrab/workspace`, configurable via:
...
Do **not** commit anything under `~/.krabkrab` (credentials, sessions, tokens).
If you need a full restore, back up both the workspace and the state directory
separately (see the migration question above).

Docs: [Agent workspace](/concepts/agent-workspace).

### How do I completely uninstall KrabKrab
...
`workspace` to the repo root. The KrabKrab repo is just source code; keep the
...
KrabKrab reads an optional **JSON5** config from `$krabkrab_CONFIG_PATH` (default: `~/.krabkrab/krabkrab.json`):

```
$krabkrab_CONFIG_PATH
```

If the file is missing, it uses safe-ish defaults (including a default workspace of `~/.krabkrab/workspace`).

### I set gatewaybind lan or tailnet and now nothing listens the UI says unauthorized

Non-loopback binds **require auth**. Configure `gateway.auth.mode` + `gateway.auth.token` (or use `krabkrab_GATEWAY_TOKEN`).
...
If you **really** want open loopback, remove `gateway.auth` from your config. Doctor can generate a token for you any time: `krabkrab doctor --generate-gateway-token`.
...
key. **Recommended:** run `krabkrab configure --section web` to store it in
...
- Daemons read env vars from `~/.krabkrab/.env` (or the service environment).
...
### Can the KrabKrab browser run headless
...
- Gateway is running: `krabkrab gateway status`
- Gateway health: `krabkrab status`
- Channel health: `krabkrab channels status`
...
### Can two KrabKrab instances talk to each other local VPS
...
`krabkrab agent --message ... --deliver`, targeting a chat where the other bot
...
- Restore from backup (git or a copied `~/.krabkrab/krabkrab.json`).
- If you have no backup, re-run `krabkrab doctor` and reconfigure channels/models.
- If this was unexpected, file a bug and include your last known config or any backup.
- A local coding agent can often reconstruct a working config from logs or history.

Avoid it:

- Use `krabkrab config set` for small changes.
- Use `krabkrab configure` for interactive edits.
...
### How does KrabKrab load environment variables

KrabKrab reads env vars from the parent process (shell, launchd/systemd, CI, etc.) and additionally loads:

- `.env` from the current working directory
- a global fallback `.env` from `~/.krabkrab/.env` (aka `$krabkrab_STATE_DIR/.env`)
...
1. Put the missing keys in `~/.krabkrab/.env` so they're picked up even when the service doesn't inherit your shell env.
...
`krabkrab_LOAD_SHELL_ENV=1`, `krabkrab_SHELL_ENV_TIMEOUT_MS=15000`.

### I set COPILOTGITHUBTOKEN but models status shows Shell env off Why

`krabkrab models status` reports whether **shell env import** is enabled. "Shell env: off"
does **not** mean your env vars are missing - it just means KrabKrab won't load
your login shell automatically.

If the Gateway runs as a service (launchd/systemd), it won't inherit your shell
environment. Fix by doing one of these:

1. Put the token in `~/.krabkrab/.env`:
...
### Is there a way to make a team of KrabKrab instances one CEO and many agents
...
### How do I completely reset KrabKrab but keep it installed
...
- If you used profiles (`--profile` / `krabkrab_PROFILE`), reset each state dir (defaults are `~/.krabkrab-<profile>`).
- Dev reset: `krabkrab gateway --dev --reset` (dev-only; wipes dev config + credentials + sessions + workspace).
...
headers like `# Heading`), KrabKrab skips the heartbeat run to save API calls.
...
No. KrabKrab runs on **your own account**, so if you're in the group, KrabKrab can see it.
...
### Why doesnt KrabKrab reply in a group
...
- **Disk growth:** sessions + transcripts live under `~/.krabkrab/agents/<agentId>/sessions/`.
...
- Use `krabkrab doctor` to spot stray workspaces and profile mismatches.
...
KrabKrab's default model is whatever you set as:

```
agents.defaults.model.primary
```

Models are referenced as `provider/model` (example: `anthropic/claude-opus-4-6`). If you omit the provider, KrabKrab currently assumes `anthropic` as a temporary deprecation fallback - but you should still **explicitly** set `provider/model`.
...
- `krabkrab models set ...` (updates just model config)
- `krabkrab configure --section model` (interactive)
- edit `agents.defaults.model` in `~/.krabkrab/krabkrab.json`

Avoid `config.apply` with a partial object unless you intend to replace the whole config.
If you did overwrite config, restore from backup or re-run `krabkrab doctor` to repair.

Docs: [Models](/concepts/models), [Configure](/cli/configure), [Config](/cli/config), [Doctor](/gateway/doctor).

### What do KrabKrab, Flawd, and Krill use for models

- **KrabKrab + Flawd:** Anthropic Opus (`anthropic/claude-opus-4-6`) - see [Anthropic](/providers/anthropic).
...
Yes. KrabKrab ships a few default shorthands (only applied when the model exists in `agents.defaults.models`):
...
- Run `krabkrab agents add <id>` and configure auth during the wizard.
...
Cooldowns apply to failing profiles (exponential backoff), so KrabKrab can keep responding even when a provider is rate-limited or temporarily failing.
...
- **Confirm where auth profiles live** (new vs legacy paths)
  - Current: `~/.krabkrab/agents/<agentId>/agent/auth-profiles.json`
  - Legacy: `~/.krabkrab/agent/*` (migrated by `krabkrab doctor`)
- **Confirm your env var is loaded by the Gateway**
  - If you set `ANTHROPIC_API_KEY` in your shell but run the Gateway via systemd/launchd, it may not inherit it. Put it in `~/.krabkrab/.env` or enable `env.shellEnv`.
- **Make sure you're editing the correct agent**
  - Multi-agent setups mean there can be multiple `auth-profiles.json` files.
- **Sanity-check model/auth status**
  - Use `krabkrab models status` to see configured models and whether providers are authenticated.
...
- **Use a setup-token**
  - Run `claude setup-token`, then paste it with `krabkrab models auth setup-token --provider anthropic`.
  - If the token was created on another machine, use `krabkrab models auth paste-token --provider anthropic`.
- **If you want to use an API key instead**
  - Put `ANTHROPIC_API_KEY` in `~/.krabkrab/.env` on the **gateway host**.
...
If your model config includes Google Gemini as a fallback (or you switched to a Gemini shorthand), KrabKrab will try it during model fallback. If you haven't configured Google credentials, you'll see `No API key found for provider "google"`.
...
Fix: KrabKrab now strips unsigned thinking blocks for Google Antigravity Claude. If it still appears, start a **new session** or set `/thinking off` for that agent.
...
KrabKrab uses provider-prefixed IDs like:
...
KrabKrab may temporarily skip a profile if it's in a short **cooldown** (rate limits/timeouts/auth failures) or a longer **disabled** state (billing/insufficient credits). To inspect this, run `krabkrab models status --json` and check `auth.unusableProfiles`. Tuning: `auth.cooldowns.billingBackoffHours*`.
...
```
--port > krabkrab_GATEWAY_PORT > gateway.port > default 18789
```

### Why does krabkrab gateway status say Runtime running but RPC probe failed

Because "running" is the **supervisor's** view (launchd/systemd/schtasks). The RPC probe is the CLI actually connecting to the gateway WebSocket and calling `status`.

Use `krabkrab gateway status` and trust these lines:

- `Probe target:` (the URL the probe actually used)
- `Listening:` (what's actually bound on the port)
- `Last gateway error:` (common root cause when the process is alive but the port isn't listening)

### Why does krabkrab gateway status show Config cli and Config service different

You're editing one config file while the service is running another (often a `--profile` / `krabkrab_STATE_DIR` mismatch).
...
KrabKrab enforces a runtime lock by binding the WebSocket listener immediately on startup (default `ws://127.0.0.1:18789`). If the bind fails with `EADDRINUSE`, it throws `GatewayLockError` indicating another instance is already listening.

Fix: stop the other instance, free the port, or run with `krabkrab gateway --port <port>`.

### How do I run KrabKrab in remote mode client connects to a Gateway elsewhere
...
- `krabkrab gateway` only starts when `gateway.mode` is `local` (or you pass the override flag).
...
- The Control UI stores the token in browser localStorage key `krabkrab.control.settings.v1`.

Fix:

- Fastest: `krabkrab dashboard` (prints + copies the dashboard URL, tries to open; shows SSH hint if headless).
- If you don't have a token yet: `krabkrab doctor --generate-gateway-token`.
- If remote, tunnel first: `ssh -N -L 18789:127.0.0.1:18789 user@host` then open `http://127.0.0.1:18789/`.
- Set `gateway.auth.token` (or `krabkrab_GATEWAY_TOKEN`) on the gateway host.
- In the Control UI settings, paste the same token.
- Still stuck? Run `krabkrab status --all` and follow [Troubleshooting](/gateway/troubleshooting). See [Dashboard](/web/dashboard) for auth details.
...
- `krabkrab_CONFIG_PATH` (per-instance config)
- `krabkrab_STATE_DIR` (per-instance state)
- `agents.defaults.workspace` (workspace isolation)
- `gateway.port` (unique ports)

Quick setup (recommended):

- Use `krabkrab --profile <name> â€¦` per instance (auto-creates `~/.krabkrab-<name>`).
- Set a unique `gateway.port` in each profile config (or pass `--port` for manual runs).
- Install a per-profile service: `krabkrab --profile <name> gateway install`.

Profiles also suffix service names (`bot.molt.<profile>`; legacy `com.krabkrab.*`, `krabkrab-gateway-<profile>.service`, `KrabKrab Gateway (<profile>)`).
...
- macOS: `$krabkrab_STATE_DIR/logs/gateway.log` and `gateway.err.log` (default: `~/.krabkrab/logs/...`; profiles use `~/.krabkrab-<profile>/logs/...`)
- Linux: `journalctl --user -u krabkrab-gateway[-<profile>].service -n 200 --no-pager`
- Windows: `schtasks /Query /TN "KrabKrab Gateway (<profile>)" /V /FO LIST`
...
If you run the gateway manually, `krabkrab gateway --force` can reclaim the port. See [Gateway](/gateway).

### I closed my terminal on Windows how do I restart KrabKrab
...
1. Is the Gateway running? `krabkrab gateway status`
2. Is the Gateway healthy? `krabkrab status`
3. Does the UI have the right token? `krabkrab dashboard`
...
### ELI5 krabkrab gateway restart vs krabkrab gateway

- `krabkrab gateway restart`: restarts the **background service** (launchd/systemd).
- `krabkrab gateway`: runs the gateway **in the foreground** for this terminal session.

If you installed the service, use the gateway commands. Use `krabkrab gateway` when
...
Outbound attachments from the agent must include a `MEDIA:<path-or-url>` line (on its own line). See [KrabKrab assistant setup](/start/krabkrab) and [Agent send](/tools/agent-send).
...
### Is it safe to expose KrabKrab to inbound DMs
...
- Default behavior on DM-capable channels is **pairing**:
  ...
  - Pending requests are capped at **3 per channel**; check `krabkrab pairing list <channel>` if a code didn't arrive.
- Opening DMs publicly requires explicit opt-in (`dmPolicy: "open"` and allowlist `"*"`).

Run `krabkrab doctor` to surface risky DM policies.
...
No. Default WhatsApp DM policy is **pairing**. Unknown senders only get a pairing code and their message is **not processed**. KrabKrab only replies to chats it receives or to explicit sends you trigger.
...
KrabKrab blocks **cross-provider** messaging by default. If a tool call is bound
