...
Deploy KrabKrab on Railway with a one-click template and finish setup in your browser.
...
- `https://<your-railway-domain>/krabkrab` â€” Control UI
...
- `krabkrab_STATE_DIR=/data/.krabkrab` (recommended)
- `krabkrab_WORKSPACE_DIR=/data/workspace` (recommended)
- `krabkrab_GATEWAY_TOKEN` (recommended; treat as an admin secret)
...
This exports your KrabKrab state + workspace so you can migrate to another host without losing config or memory.
