...
KrabKrab treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.krabkrab/settings/voicewake.json`

Shape:

```json
{ "triggers": ["krabkrab", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
