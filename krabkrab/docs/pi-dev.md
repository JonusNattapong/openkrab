...
This guide summarizes a sane workflow for working on the pi integration in KrabKrab.
...
State lives under the KrabKrab state directory. Default is `~/.krabkrab`. If `krabkrab_STATE_DIR` is set, use that directory instead.

To reset everything:

- `krabkrab.json` for config
...
- [https://docs.krabkrab.ai/testing](https://docs.krabkrab.ai/testing)
- [https://docs.krabkrab.ai/start/getting-started](https://docs.krabkrab.ai/start/getting-started)
