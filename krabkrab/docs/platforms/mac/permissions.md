...
- Same path: run the app from a fixed location (for KrabKrab, `dist/KrabKrab.app`).
...
Workaround: move files into the KrabKrab workspace (`~/.krabkrab/workspace`) if you want to avoid per-folder grants.
