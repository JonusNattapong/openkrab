...
read_when:
  - You are building a KrabKrab plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (krabkrab.plugin.json)

Every plugin **must** ship a `krabkrab.plugin.json` file in the **plugin root**.
KrabKrab uses this manifest to validate configuration **without executing plugin
