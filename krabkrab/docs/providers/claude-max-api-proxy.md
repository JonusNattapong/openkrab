...
You can point KrabKrab at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or KrabKrab
...
- [Anthropic provider](/providers/anthropic) - Native KrabKrab integration with Claude setup-token or API keys
