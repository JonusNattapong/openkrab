---
summary: "Use NVIDIA's OpenAI-compatible API in KrabKrab"
read_when:
  - You want to use NVIDIA models in KrabKrab
...
krabkrab onboard --auth-choice skip
krabkrab models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
