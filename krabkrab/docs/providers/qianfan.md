---
summary: "Use Qianfan's unified API to access many models in KrabKrab"
read_when:
...
3. KrabKrab installed on your system
...
4. Copy the API key for use with KrabKrab

## CLI setup

```bash
krabkrab onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [KrabKrab Configuration](/gateway/configuration)
