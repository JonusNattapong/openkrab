---
summary: "Use Qwen OAuth (free tier) in KrabKrab"
read_when:
  - You want to use Qwen with KrabKrab
...
If you already logged in with the Qwen Code CLI, KrabKrab will sync credentials
