---
summary: "Use Synthetic's Anthropic-compatible API in KrabKrab"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. KrabKrab registers it as the
...
Note: KrabKrab's Anthropic client appends `/v1` to the base URL, so use
