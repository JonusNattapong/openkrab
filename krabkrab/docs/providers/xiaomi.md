---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with KrabKrab"
read_when:
  - You want Xiaomi MiMo models in KrabKrab
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). KrabKrab uses
