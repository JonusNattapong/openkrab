---
summary: "Overview of KrabKrab onboarding options and flows"
read_when:
...
KrabKrab supports multiple onboarding paths depending on where the Gateway runs
...
- [`krabkrab onboard` command](/cli/onboard)

## macOS app onboarding

Use the KrabKrab app when you want a fully guided setup on macOS. Docs:
