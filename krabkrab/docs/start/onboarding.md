---
summary: "First-run onboarding flow for KrabKrab (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give KrabKrab">
...
<Step title="CLI">
  ...
  The app can install the global `krabkrab` CLI via npm/pnpm so terminal
