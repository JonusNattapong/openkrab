...
pub async fn ask_command(query: &str, db_path: Option<&str>) -> Result<String> {
    ...
    let tools: Vec<Box<dyn crate::agents::Tool>> = vec![
        ...
        Box::new(crate::agents::ExecCommandTool::new(workspace_root.clone(), true)), // Security: Require approval
        Box::new(crate::agents::RememberTool::new(memory_manager.clone(), workspace_root.clone())),
