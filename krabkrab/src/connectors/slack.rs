...
impl SlackConnector {
    pub fn new() -> Self { SlackConnector }
...
mod tests {
    ...
    fn test_parse_user_mention_simple() {
        assert_eq!(SlackConnector::parse_user_mention("<@U12345>"), Some("U12345".to_string()));
        assert_eq!(SlackConnector::parse_user_mention("<@U12345|alice>"), Some("U12345".to_string()));
    ...
    fn test_extract_first_mention() {
        ...
        assert_eq!(SlackConnector::extract_first_mention(txt), Some("U1".to_string()));
    }
}
