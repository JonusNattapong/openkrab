...
use crate::commands::{
    ...
    status_daemon::{get_daemon_status, get_agent_local_status, format_daemon_status, format_agent_local_status},
};
...
pub fn status_simple() -> String {
    ...
    format!("OK — {} providers registered [{}]", providers.len(), provider_text)
}
