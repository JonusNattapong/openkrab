...
export const A2UI_PATH = "/__krabkrab__/a2ui";

export const CANVAS_HOST_PATH = "/__krabkrab__/canvas";

export const CANVAS_WS_PATH = "/__krabkrab__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.krabkrabCanvasA2UIAction.postMessage(...)
  // - Android: window.krabkrabCanvasA2UIAction.postMessage(...)
  const handlerNames = ["krabkrabCanvasA2UIAction"];
  ...
  globalThis.krabkrab = globalThis.krabkrab ?? {};
  globalThis.krabkrab.postMessage = postToNode;
  globalThis.krabkrab.sendUserAction = sendUserAction;
  globalThis.krabkrabPostMessage = postToNode;
  globalThis.krabkrabSendUserAction = sendUserAction;
