...
export function listWhatsAppAuthDirs(cfg: krabkrabConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: krabkrabConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: krabkrabConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: krabkrabConfig): ResolvedWhatsAppAccount[] {
