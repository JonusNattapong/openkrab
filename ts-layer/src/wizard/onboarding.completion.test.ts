...
describe("setupOnboardingShellCompletion", () => {
  it("QuickStart: installs without prompting", async () => {
    ...
    expect(deps.ensureCompletionCacheExists).toHaveBeenCalledWith("krabkrab");
    expect(deps.installCompletion).toHaveBeenCalledWith("zsh", true, "krabkrab");
