...
1. Click [Deploy OpenKrab](https://northflank.com/stacks/deploy-OpenKrab) to open the template.
...
9. Open the Control UI at `/OpenKrab`.
...
4. Click **Run setup**.
5. Open the Control UI at `https://<your-northflank-domain>/OpenKrab`
