...
<a href="https://railway.com/deploy.openkrab-railway-template" target="_blank" rel="noreferrer">
  Deploy on Railway
</a>
...
- `https://<your-railway-domain>/OpenKrab` — Control UI
...
- `OPENKRAB_STATE_DIR=/data/.OpenKrab` (recommended)
- `OPENKRAB_WORKSPACE_DIR=/data/workspace` (recommended)
- `OPENKRAB_GATEWAY_TOKEN` (recommended; treat as an admin secret)
