...
[Deploy to Render](https://render.com/deploy?repo=https://github.com/OpenKrab/OpenKrab)
...
services:
  - type: web
    ...
    envVars:
      ...
      - key: OPENKRAB_STATE_DIR
        value: /data/.OpenKrab
      - key: OPENKRAB_WORKSPACE_DIR
        value: /data/workspace
      - key: OPENKRAB_GATEWAY_TOKEN
...
The web dashboard is available at `https://<your-service>.onrender.com/OpenKrab`.
