...
<Columns>
  ...
  <Card title="ウィザードを実行" href="/start/wizard" icon="sparkles">
    `OpenKrab onboard`とペアリングフローによるガイド付きセットアップ。
  </Card>
...
<p align="center">
  <img src="whatsapp-OpenKrab.jpg" alt="OpenKrab" width="420" />
</p>

## 設定（オプション）

設定は`~/.OpenKrab/OpenKrab.json`にあります。
...
```json5
{
  ...
  messages: { groupChat: { mentionPatterns: ["@OpenKrab"] } },
}
```
