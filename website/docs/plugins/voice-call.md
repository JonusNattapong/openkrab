...
- Use `OpenKrab voicecall ...` or the `voice_call` tool
...
```bash
OpenKrab plugins install ./extensions/voice-call
...
```bash
OpenKrab voicecall call --to "+15555550123" --message "Hello from OpenKrab"
OpenKrab voicecall continue --call-id <id> --message "Any questions?"
OpenKrab voicecall speak --call-id <id> --message "One moment"
OpenKrab voicecall end --call-id <id>
OpenKrab voicecall status --call-id <id>
OpenKrab voicecall tail
