...
```bash
OpenKrab onboard --auth-choice venice-api-key
```
...
```bash
OpenKrab chat --model venice/llama-3.3-70b "Hello, are you working?"
```
...
```bash
OpenKrab models set venice/claude-opus-45
OpenKrab models set venice/llama-3.3-70b
```

List all available models:

```bash
OpenKrab models list | grep venice
```

## Configure via `OpenKrab configure`

1. Run `OpenKrab configure`
2. Select **Model/auth**
3. Choose **Venice AI**
...
OpenKrab chat --model venice/llama-3.3-70b

# Use Claude via Venice (anonymized)
OpenKrab chat --model venice/claude-opus-45

# Use uncensored model
OpenKrab chat --model venice/venice-uncensored

# Use vision model with image
OpenKrab chat --model venice/qwen3-vl-235b-a22b

# Use coding model
OpenKrab chat --model venice/qwen3-coder-480b-a35b-instruct
```
...
The Venice model catalog updates dynamically. Run `OpenKrab models list` to see currently available models. Some models may be temporarily offline.
