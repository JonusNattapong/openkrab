...
- Publish as `OpenKrab/plugin-sdk` (or export from core under `OpenKrab/plugin-sdk`).
...
- Plugins declare a required runtime range (e.g., `OpenKrabRuntime: ">=2026.2.0"`).
