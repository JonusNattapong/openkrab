...
- `OpenKrab status --usage` and `OpenKrab channels list` show provider **usage windows**
...
`OpenKrab models scan` can probe OpenRouter models and uses `OPENROUTER_API_KEY` when
probing is enabled.
