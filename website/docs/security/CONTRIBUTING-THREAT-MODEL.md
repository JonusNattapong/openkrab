...
Spotted an attack vector or risk we haven't covered? Open an issue on [OpenKrab/trust](https://github.com/OpenKrab/trust/issues) and describe it in your own words. You don't need to know any frameworks or fill in every field - just describe the scenario.
...
> **This is for adding to the threat model, not reporting live vulnerabilities.** If you've found an exploitable vulnerability, see our [Trust page](https://trust.OpenKrab.ai) for responsible disclosure instructions.
...
- **Security vulnerabilities:** See our [Trust page](https://trust.OpenKrab.ai) for reporting instructions
- **Threat model questions:** Open an issue on [OpenKrab/trust](https://github.com/OpenKrab/trust/issues)
