...
Models are maintained in a separate repo: [vignesh07/OpenKrab-formal-models](https://github.com/vignesh07/OpenKrab-formal-models).
...
```bash
git clone https://github.com/vignesh07/OpenKrab-formal-models
cd OpenKrab-formal-models
