...
<Info>
**Want to be featured?** Share your project in [#showcase on Discord](https://discord.gg/Krabd) or [tag @OpenKrab on X](https://x.com/OpenKrab).
</Info>

## ðŸŽ¥ OpenKrab in Action
...
OpenCode finishes the change â†’ opens a PR â†’ OpenKrab reviews the diff and replies in Telegram with â€œminor suggestionsâ€ plus a clear merge verdict (including critical fixes to apply first).
...
Asked â€œRobbyâ€ (@OpenKrab) for a local wine cellar skill. It requests a sample CSV export + where to store it, then builds/tests the skill fast (962 bottles in the example).
...
<Card title="Bambu 3D Printer Control" icon="print" href="https://KrabHub.com/tobiasbischoff/bambu-cli">
...
<Card title="Vienna Transport (Wiener Linien)" icon="train" href="https://KrabHub.com/hjanuschka/wienerlinien">
...
<Card title="R2 Upload (Send Me My Files)" icon="cloud-arrow-up" href="https://KrabHub.com/skills/r2-upload">
...
14+ agents under one gateway with Opus 4.5 orchestrator delegating to Codex workers. Comprehensive [technical write-up](https://github.com/adam91holt/orchestrated-ai-articles) covering the Dream Team roster, model selection, sandboxing, webhooks, heartbeats, and delegation flows. [Krabdspace](https://github.com/adam91holt/Krabdspace) for agent sandboxing. [Blog post](https://adams-ai-journey.ghost.io/2026-the-year-of-the-orchestrator/).
</Card>
...
Triggered by a roof camera: ask OpenKrab to snap a sky photo whenever it looks pretty â€” it designed a skill and took the shot.
...
OpenKrab connected to Jira, then generated a new skill on the fly (before it existed on KrabHub).
</Card>
...
<Card title="Krabdia Phone Bridge" icon="phone" href="https://github.com/alejandroOPI/Krabdia-bridge">
  **@alejandroOPI** â€¢ `voice` `vapi` `bridge`
  
  Vapi voice assistant â†” OpenKrab HTTP bridge. Near real-time phone calls with your agent.
</Card>

<Card title="OpenRouter Transcription" icon="microphone" href="https://KrabHub.com/obviyus/openrouter-transcribe">
  **@obviyus** â€¢ `transcription` `multilingual` `skill`

Multi-lingual audio transcription via OpenRouter (Gemini, etc). Available on KrabHub.
</Card>
...
<Card title="Home Assistant Add-on" icon="home" href="https://github.com/ngutman/OpenKrab-ha-addon">
...
<Card title="Nix Packaging" icon="snowflake" href="https://github.com/OpenKrab/nix-OpenKrab">
  **@OpenKrab** â€¢ `nix` `packaging` `deployment`
  
  Batteries-included nixified OpenKrab configuration for reproducible deployments.
</Card>

<Card title="CalDAV Calendar" icon="calendar" href="https://KrabHub.com/skills/caldav-calendar">
...
<Steps>
  <Step title="Share It">
    Post in [#showcase on Discord](https://discord.gg/Krabd) or [tweet @OpenKrab](https://x.com/OpenKrab)
  </Step>
