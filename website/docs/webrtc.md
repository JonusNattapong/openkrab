...
WebRTC endpoints inherit the security constraints applied globally inside `OpenKrab.json` (such as checking `CORS` properties using the Gateway's internal permissive Layer config).
