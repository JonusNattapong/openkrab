---
read_when:
  - ä¸º OpenKrab è®¾ç½® Twitch èŠå¤©é›†æˆ
...
é€šè¿‡ IRC è¿žæŽ¥æ”¯æŒ Twitch èŠå¤©ã€‚OpenKrab ä»¥ Twitch ç”¨æˆ·ï¼ˆæœºå™¨äººè´¦æˆ·ï¼‰èº«ä»½è¿žæŽ¥ï¼Œåœ¨é¢‘é“ä¸­æŽ¥æ”¶å’Œå‘é€æ¶ˆæ¯ã€‚
...
4. é…ç½®ä»¤ç‰Œï¼š
   - çŽ¯å¢ƒå˜é‡ï¼š`OPENKRAB_TWITCH_ACCESS_TOKEN=...`ï¼ˆä»…é™é»˜è®¤è´¦æˆ·ï¼‰
...
```json5
{
  channels: {
    twitch: {
      enabled: true,
      username: "OpenKrab", // æœºå™¨äººçš„ Twitch è´¦æˆ·
      accessToken: "oauth:abc123...", // OAuth Access Tokenï¼ˆæˆ–ä½¿ç”¨ OPENKRAB_TWITCH_ACCESS_TOKEN çŽ¯å¢ƒå˜é‡ï¼‰
