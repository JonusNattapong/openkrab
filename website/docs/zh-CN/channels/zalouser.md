...
- 通过 CLI 安装：`OpenKrab plugins install @OpenKrab/zalouser`
- 或从源码检出安装：`OpenKrab plugins install ./extensions/zalouser`
- 详情：[插件](/tools/plugin)
...
- 重新登录：`OpenKrab channels logout --channel zalouser && OpenKrab channels login --channel zalouser`
