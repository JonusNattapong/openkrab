...
- å¦‚æžœè®¾ç½®äº† `OPENKRAB_GATEWAY_TOKEN`ï¼ˆæˆ– `--token`ï¼‰ï¼Œ`connect.params.auth.token` å¿…é¡»åŒ¹é…ï¼Œå¦åˆ™å¥—æŽ¥å­—å…³é—­ã€‚
...
- å¯åŠ¨ï¼š`OpenKrab gateway`ï¼ˆå‰å°ï¼Œæ—¥å¿—è¾“å‡ºåˆ° stdoutï¼‰ã€‚
