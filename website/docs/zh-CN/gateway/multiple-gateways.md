...
summary: åœ¨åŒä¸€ä¸»æœºä¸Šè¿è¡Œå¤šä¸ª OpenKrab Gateway ç½‘å…³ï¼ˆéš”ç¦»ã€ç«¯å£å’Œé…ç½®æ–‡ä»¶ï¼‰
...
- `OPENKRAB_CONFIG_PATH` â€” æ¯ä¸ªå®žä¾‹çš„é…ç½®æ–‡ä»¶
- `OPENKRAB_STATE_DIR` â€” æ¯ä¸ªå®žä¾‹çš„ä¼šè¯ã€å‡­è¯ã€ç¼“å­˜
...
é…ç½®æ–‡ä»¶è‡ªåŠ¨é™å®š `OPENKRAB_STATE_DIR` + `OPENKRAB_CONFIG_PATH` èŒƒå›´å¹¶ä¸ºæœåŠ¡åç§°æ·»åŠ åŽç¼€ã€‚
...
åŸºç¡€ç«¯å£ = `gateway.port`ï¼ˆæˆ– `OPENKRAB_GATEWAY_PORT` / `--port`ï¼‰ã€‚
