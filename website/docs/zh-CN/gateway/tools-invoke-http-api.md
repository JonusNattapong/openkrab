...
OpenKrab çš„ Gateway ç½‘å…³æš´éœ²äº†ä¸€ä¸ªç®€å•çš„ HTTP ç«¯ç‚¹ç”¨äºŽç›´æŽ¥è°ƒç”¨å•ä¸ªå·¥å…·ã€‚å®ƒå§‹ç»ˆå¯ç”¨ï¼Œä½†å— Gateway ç½‘å…³è®¤è¯å’Œå·¥å…·ç­–ç•¥é™åˆ¶ã€‚
...
- `x-OpenKrab-message-channel: <channel>`ï¼ˆç¤ºä¾‹ï¼š`slack`ã€`telegram`ï¼‰
- `x-OpenKrab-account-id: <accountId>`ï¼ˆå½“å­˜åœ¨å¤šä¸ªè´¦æˆ·æ—¶ï¼‰
