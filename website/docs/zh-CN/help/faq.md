---
summary: å…³äºŽ OpenKrab å®‰è£…ã€é…ç½®å’Œä½¿ç”¨çš„å¸¸è§é—®é¢˜
title: å¸¸è§é—®é¢˜
x-i18n:
...
- [å¿«é€Ÿå¼€å§‹ä¸Žé¦–æ¬¡è¿è¡Œè®¾ç½®](#quick-start-and-firstrun-setup)
  ...
  - [å®‰è£…å’Œè®¾ç½® OpenKrab çš„æŽ¨èæ–¹å¼æ˜¯ä»€ä¹ˆï¼Ÿ](#whats-the-recommended-way-to-install-and-set-up-OpenKrab)
  ...
  - [æ— æ³•è®¿é—® docs.OpenKrab.aiï¼ˆSSL é”™è¯¯ï¼‰ï¼Œæ€Žä¹ˆåŠžï¼Ÿ](#i-cant-access-docsOpenKrabai-ssl-error-what-now)
...
- [å¦‚ä½•å®‰è£… beta ç‰ˆæœ¬ï¼Œbeta å’Œ dev æœ‰ä»€ä¹ˆåŒºåˆ«ï¼Ÿ](#how-do-i-install-the-beta-version-and-whats-the-difference-between-beta-and-dev)
  ...
  - [Windows å®‰è£…æç¤ºæ‰¾ä¸åˆ° git æˆ–æ— æ³•è¯†åˆ« OpenKrab](#windows-install-says-git-not-found-or-OpenKrab-not-recognized)
  - [æ–‡æ¡£æ²¡æœ‰è§£ç­”æˆ‘çš„é—®é¢˜â€”â€”å¦‚ä½•èŽ·å¾—æ›´å¥½çš„ç­”æ¡ˆï¼Ÿ](#the-docs-didnt-answer-my-question-how-do-i-get-a-better-answer)
  - [å¦‚ä½•åœ¨ Linux ä¸Šå®‰è£… OpenKrabï¼Ÿ](#how-do-i-install-OpenKrab-on-linux)
  - [å¦‚ä½•åœ¨ VPS ä¸Šå®‰è£… OpenKrabï¼Ÿ](#how-do-i-install-OpenKrab-on-a-vps)
  - [äº‘/VPS å®‰è£…æŒ‡å—åœ¨å“ªé‡Œï¼Ÿ](#where-are-the-cloudvps-install-guides)
  - [å¯ä»¥è®© OpenKrab è‡ªè¡Œæ›´æ–°å—ï¼Ÿ](#can-i-ask-OpenKrab-to-update-itself)
  - [æ–°æ‰‹å¼•å¯¼å‘å¯¼å…·ä½“åšäº†ä»€ä¹ˆï¼Ÿ](#what-does-the-onboarding-wizard-actually-do)
  - [è¿è¡Œ OpenKrab éœ€è¦ Claude æˆ– OpenAI è®¢é˜…å—ï¼Ÿ](#do-i-need-a-claude-or-openai-subscription-to-run-this)
  ...
  - [å¦‚æžœæˆ‘ä¹°äº† Mac mini è¿è¡Œ OpenKrabï¼Œèƒ½è¿žæŽ¥åˆ°æˆ‘çš„ MacBook Pro å—ï¼Ÿ](#if-i-buy-a-mac-mini-to-run-OpenKrab-can-i-connect-it-to-my-macbook-pro)
  - [å¯ä»¥ä½¿ç”¨ Bun å—ï¼Ÿ](#can-i-use-bun)
  - [Telegramï¼š`allowFrom` å¡«ä»€ä¹ˆï¼Ÿ](#telegram-what-goes-in-allowfrom)
  - [å¤šäººèƒ½å¦ä½¿ç”¨åŒä¸€ä¸ª WhatsApp å·ç é…åˆä¸åŒçš„ OpenKrab å®žä¾‹ï¼Ÿ](#can-multiple-people-use-one-whatsapp-number-with-different-OpenKrab-instances)
  ...
  - [åœ¨ä¸“ç”¨æœºå™¨ä¸Šè¿è¡Œ OpenKrab æœ‰å¤šé‡è¦ï¼Ÿ](#how-important-is-it-to-run-OpenKrab-on-a-dedicated-machine)
  - [VPS çš„æœ€ä½Žè¦æ±‚å’ŒæŽ¨èæ“ä½œç³»ç»Ÿæ˜¯ä»€ä¹ˆï¼Ÿ](#what-are-the-minimum-vps-requirements-and-recommended-os)
  - [å¯ä»¥åœ¨è™šæ‹Ÿæœºä¸­è¿è¡Œ OpenKrab å—ï¼Ÿæœ‰ä»€ä¹ˆè¦æ±‚ï¼Ÿ](#can-i-run-OpenKrab-in-a-vm-and-what-are-the-requirements)
- [ä»€ä¹ˆæ˜¯ OpenKrabï¼Ÿ](#what-is-OpenKrab)
  - [ç”¨ä¸€æ®µè¯æè¿° OpenKrabï¼Ÿ](#what-is-OpenKrab-in-one-paragraph)
  - [ä»·å€¼ä¸»å¼ æ˜¯ä»€ä¹ˆï¼Ÿ](#whats-the-value-proposition)
  - [åˆšè®¾ç½®å¥½ï¼Œåº”è¯¥å…ˆåšä»€ä¹ˆï¼Ÿ](#i-just-set-it-up-what-should-i-do-first)
  - [OpenKrab æ—¥å¸¸æœ€å¸¸ç”¨çš„äº”ä¸ªåœºæ™¯æ˜¯ä»€ä¹ˆï¼Ÿ](#what-are-the-top-five-everyday-use-cases-for-OpenKrab)
  - [OpenKrab èƒ½å¦å¸®åŠ© SaaS è¿›è¡ŒèŽ·å®¢ã€å¤–è”ã€å¹¿å‘Šå’Œåšå®¢ï¼Ÿ](#can-OpenKrab-help-with-lead-gen-outreach-ads-and-blogs-for-a-saas)
...
- [Skills ä¸Žè‡ªåŠ¨åŒ–](#skills-and-automation)
  ...
  - [OpenKrab èƒ½å¦æŒ‰è®¡åˆ’æˆ–åœ¨åŽå°æŒç»­è¿è¡Œä»»åŠ¡ï¼Ÿ](#can-OpenKrab-run-tasks-on-a-schedule-or-continuously-in-the-background)
...
- [ç£ç›˜ä¸Šçš„æ–‡ä»¶ä½ç½®](#where-things-live-on-disk)
  - [OpenKrab ä½¿ç”¨çš„æ‰€æœ‰æ•°æ®éƒ½ä¿å­˜åœ¨æœ¬åœ°å—ï¼Ÿ](#is-all-data-used-with-OpenKrab-saved-locally)
  - [OpenKrab å°†æ•°æ®å­˜å‚¨åœ¨å“ªé‡Œï¼Ÿ](#where-does-OpenKrab-store-its-data)
  ...
  - [å¦‚ä½•å®Œå…¨å¸è½½ OpenKrabï¼Ÿ](#how-do-i-completely-uninstall-OpenKrab)
...
- [é…ç½®åŸºç¡€](#config-basics)
  ...
  - [OpenKrab æµè§ˆå™¨å¯ä»¥æ— å¤´è¿è¡Œå—ï¼Ÿ](#can-the-OpenKrab-browser-run-headless)
...
- [è¿œç¨‹ Gateway ç½‘å…³ä¸ŽèŠ‚ç‚¹](#remote-gateways-nodes)
  ...
  - [ä¸¤ä¸ª OpenKrab å®žä¾‹ï¼ˆæœ¬åœ° + VPSï¼‰å¯ä»¥äº’ç›¸é€šä¿¡å—ï¼Ÿ](#can-two-OpenKrab-instances-talk-to-each-other-local-vps)
...
- [çŽ¯å¢ƒå˜é‡å’Œ .env åŠ è½½](#env-vars-and-env-loading)
  - [OpenKrab å¦‚ä½•åŠ è½½çŽ¯å¢ƒå˜é‡ï¼Ÿ](#how-does-OpenKrab-load-environment-variables)
...
- [ä¼šè¯ä¸Žå¤šèŠå¤©](#sessions-multiple-chats)
  ...
  - [èƒ½å¦åˆ›å»ºä¸€ä¸ª OpenKrab å®žä¾‹å›¢é˜Ÿâ€”â€”ä¸€ä¸ª CEO å’Œå¤šä¸ªæ™ºèƒ½ä½“ï¼Ÿ](#is-there-a-way-to-make-a-team-of-OpenKrab-instances-one-ceo-and-many-agents)
  - [ä¸ºä»€ä¹ˆä¸Šä¸‹æ–‡åœ¨ä»»åŠ¡ä¸­é€”è¢«æˆªæ–­äº†ï¼Ÿå¦‚ä½•é˜²æ­¢ï¼Ÿ](#why-did-context-get-truncated-midtask-how-do-i-prevent-it)
  - [å¦‚ä½•å®Œå…¨é‡ç½® OpenKrab ä½†ä¿ç•™å®‰è£…ï¼Ÿ](#how-do-i-completely-reset-OpenKrab-but-keep-it-installed)
  ...
  - [ä¸ºä»€ä¹ˆ OpenKrab ä¸åœ¨ç¾¤ç»„ä¸­å›žå¤ï¼Ÿ](#why-doesnt-OpenKrab-reply-in-a-group)
...
- [æ¨¡åž‹ï¼šé»˜è®¤å€¼ã€é€‰æ‹©ã€åˆ«åã€åˆ‡æ¢](#models-defaults-selection-aliases-switching)
  ...
  - [OpenKrabã€Flawd å’Œ Krill ä½¿ç”¨ä»€ä¹ˆæ¨¡åž‹ï¼Ÿ](#what-do-OpenKrab-flawd-and-krill-use-for-models)
...
- [Gateway ç½‘å…³ï¼šç«¯å£ã€â€œå·²åœ¨è¿è¡Œâ€å’Œè¿œç¨‹æ¨¡å¼](#gateway-ports-already-running-and-remote-mode)
  ...
  - [ä¸ºä»€ä¹ˆ `OpenKrab gateway status` æ˜¾ç¤º `Runtime: running` ä½† `RPC probe: failed`ï¼Ÿ](#why-does-OpenKrab-gateway-status-say-runtime-running-but-rpc-probe-failed)
  - [ä¸ºä»€ä¹ˆ `OpenKrab gateway status` æ˜¾ç¤º `Config (cli)` å’Œ `Config (service)` ä¸åŒï¼Ÿ](#why-does-OpenKrab-gateway-status-show-config-cli-and-config-service-different)
  ...
  - [å¦‚ä½•ä»¥è¿œç¨‹æ¨¡å¼è¿è¡Œ OpenKrabï¼ˆå®¢æˆ·ç«¯è¿žæŽ¥åˆ°å…¶ä»–ä½ç½®çš„ Gateway ç½‘å…³ï¼‰ï¼Ÿ](#how-do-i-run-OpenKrab-in-remote-mode-client-connects-to-a-gateway-elsewhere)
...
- [æ—¥å¿—ä¸Žè°ƒè¯•](#logging-and-debugging)
  ...
  - [æˆ‘åœ¨ Windows ä¸Šå…³é—­äº†ç»ˆç«¯â€”â€”å¦‚ä½•é‡å¯ OpenKrabï¼Ÿ](#i-closed-my-terminal-on-windows-how-do-i-restart-OpenKrab)
  ...
  - [é€šä¿—è§£é‡Šï¼š`OpenKrab gateway restart` ä¸Ž `OpenKrab gateway`](#eli5-OpenKrab-gateway-restart-vs-OpenKrab-gateway)
...
- [å®‰å…¨ä¸Žè®¿é—®æŽ§åˆ¶](#security-and-access-control)
  - [å°† OpenKrab æš´éœ²ç»™å…¥ç«™ç§ä¿¡å®‰å…¨å—ï¼Ÿ](#is-it-safe-to-expose-OpenKrab-to-inbound-dms)
...
7. **Gateway ç½‘å…³å¿«ç…§**
   ...
   OpenKrab health --verbose   # å‡ºé”™æ—¶æ˜¾ç¤ºç›®æ ‡ URL + é…ç½®è·¯å¾„
   ```
...
è¿™ä¼šä»Ž **git checkout** å®‰è£… OpenKrabï¼Œè¿™æ ·æ™ºèƒ½ä½“å¯ä»¥è¯»å–ä»£ç  + æ–‡æ¡£ï¼Œå¹¶æŽ¨ç†ä½ æ­£åœ¨è¿è¡Œçš„ç¡®åˆ‡ç‰ˆæœ¬ã€‚ä½ å¯ä»¥éšæ—¶é€šè¿‡ä¸å¸¦ `--install-method git` é‡æ–°è¿è¡Œå®‰è£…ç¨‹åºåˆ‡å›žç¨³å®šç‰ˆã€‚
...
https://github.com/OpenKrab/OpenKrab/issues
https://github.com/OpenKrab/OpenKrab/pulls
...
- `OpenKrab status`ï¼šGateway ç½‘å…³/æ™ºèƒ½ä½“å¥åº·çŠ¶å†µ + åŸºæœ¬é…ç½®çš„å¿«é€Ÿå¿«ç…§ã€‚
- `OpenKrab models status`ï¼šæ£€æŸ¥æä¾›å•†è®¤è¯ + æ¨¡åž‹å¯ç”¨æ€§ã€‚
- `OpenKrab doctor`ï¼šéªŒè¯å¹¶ä¿®å¤å¸¸è§çš„é…ç½®/çŠ¶æ€é—®é¢˜ã€‚

å…¶ä»–æœ‰ç”¨çš„ CLI æ£€æŸ¥ï¼š`OpenKrab status --all`ã€`OpenKrab logs --follow`ã€
`OpenKrab gateway status`ã€`OpenKrab health --verbose`ã€‚
...
### å®‰è£…å’Œè®¾ç½® OpenKrab çš„æŽ¨èæ–¹å¼æ˜¯ä»€ä¹ˆ
...
å¦‚æžœä½ è¿˜æ²¡æœ‰å…¨å±€å®‰è£…ï¼Œé€šè¿‡ `pnpm OpenKrab onboard` è¿è¡Œã€‚
...
- å¦‚æžœè¦æ±‚è®¤è¯ï¼Œè¿è¡Œ `OpenKrab dashboard` å¹¶ä½¿ç”¨å¸¦ä»¤ç‰Œçš„é“¾æŽ¥ï¼ˆ`?token=...`ï¼‰ã€‚
- ä»¤ç‰Œä¸Ž `gateway.auth.token`ï¼ˆæˆ– `OPENKRAB_GATEWAY_TOKEN`ï¼‰çš„å€¼ç›¸åŒï¼ŒUI åœ¨é¦–æ¬¡åŠ è½½åŽä¼šå­˜å‚¨å®ƒã€‚

**éžæœ¬åœ°çŽ¯å¢ƒï¼š**

- **Tailscale Serve**ï¼ˆæŽ¨èï¼‰ï¼šä¿æŒç»‘å®š loopbackï¼Œè¿è¡Œ `OpenKrab gateway --tailscale serve`ï¼Œæ‰“å¼€ `https://<magicdns>/`ã€‚å¦‚æžœ `gateway.auth.allowTailscale` ä¸º `true`ï¼Œèº«ä»½æ ‡å¤´æ»¡è¶³è®¤è¯è¦æ±‚ï¼ˆæ— éœ€ä»¤ç‰Œï¼‰ã€‚
- **Tailnet ç»‘å®š**ï¼šè¿è¡Œ `OpenKrab gateway --bind tailnet --token "<token>"`ï¼Œæ‰“å¼€ `http://<tailscale-ip>:18789/`ï¼Œåœ¨ä»ªè¡¨æ¿è®¾ç½®ä¸­ç²˜è´´ä»¤ç‰Œã€‚
- **SSH éš§é“**ï¼š`ssh -N -L 18789:127.0.0.1:18789 user@host`ï¼Œç„¶åŽä»Ž `OpenKrab dashboard` æ‰“å¼€ `http://127.0.0.1:18789/?token=...`ã€‚
...
1. åœ¨æ–°æœºå™¨ä¸Šå®‰è£… OpenKrabã€‚
2. ä»Žæ—§æœºå™¨å¤åˆ¶ `$OPENKRAB_STATE_DIR`ï¼ˆé»˜è®¤ï¼š`~/.OpenKrab`ï¼‰ã€‚
3. å¤åˆ¶ä½ çš„å·¥ä½œåŒºï¼ˆé»˜è®¤ï¼š`~/.OpenKrab/workspace`ï¼‰ã€‚
4. è¿è¡Œ `OpenKrab doctor` å¹¶é‡å¯ Gateway ç½‘å…³æœåŠ¡ã€‚
...
**é‡è¦ï¼š** å¦‚æžœä½ åªå°†å·¥ä½œåŒºæäº¤/æŽ¨é€åˆ° GitHubï¼Œä½ åªå¤‡ä»½äº†**è®°å¿† + å¼•å¯¼æ–‡ä»¶**ï¼Œä½†**ä¸åŒ…æ‹¬**ä¼šè¯åŽ†å²æˆ–è®¤è¯ã€‚å®ƒä»¬ä½äºŽ `~/.OpenKrab/` ä¸‹ï¼ˆä¾‹å¦‚ `~/.OpenKrab/agents/<agentId>/sessions/`ï¼‰ã€‚

ç›¸å…³ï¼š[è¿ç§»](/install/migrating)ã€[ç£ç›˜ä¸Šçš„æ–‡ä»¶ä½ç½®](/help/faq#where-does-OpenKrab-store-its-data)ã€
...
https://github.com/OpenKrab/OpenKrab/blob/main/CHANGELOG.md
...
### æ— æ³•è®¿é—® docs.OpenKrab.aiï¼ˆSSL é”™è¯¯ï¼‰ï¼Œæ€Žä¹ˆåŠž

ä¸€äº› Comcast/Xfinity è¿žæŽ¥é€šè¿‡ Xfinity Advanced Security é”™è¯¯åœ°æ‹¦æˆªäº† `docs.OpenKrab.ai`ã€‚ç¦ç”¨è¯¥åŠŸèƒ½æˆ–å°† `docs.OpenKrab.ai` åŠ å…¥ç™½åå•ï¼Œç„¶åŽé‡è¯•ã€‚æ›´å¤šè¯¦æƒ…ï¼š[æ•…éšœæŽ’é™¤](/help/troubleshooting#docsOpenKrabai-shows-an-ssl-error-comcastxfinity)ã€‚
...
https://github.com/OpenKrab/OpenKrab/tree/main/docs
...
### Windows å®‰è£…æç¤ºæ‰¾ä¸åˆ° git æˆ–æ— æ³•è¯†åˆ« OpenKrab
...
**2) OpenKrab is not recognizedï¼ˆå®‰è£…åŽï¼‰**
...
`OpenKrab onboard` æ˜¯æŽ¨èçš„è®¾ç½®è·¯å¾„ã€‚åœ¨**æœ¬åœ°æ¨¡å¼**ä¸‹ï¼Œå®ƒå¼•å¯¼ä½ å®Œæˆï¼š
...
### è¿è¡Œ OpenKrab éœ€è¦ Claude æˆ– OpenAI è®¢é˜…å—

ä¸éœ€è¦ã€‚ä½ å¯ä»¥ä½¿ç”¨ **API å¯†é’¥**ï¼ˆAnthropic/OpenAI/å…¶ä»–ï¼‰æˆ–**çº¯æœ¬åœ°æ¨¡åž‹**è¿è¡Œ OpenKrabï¼Œè¿™æ ·ä½ çš„æ•°æ®ç•™åœ¨ä½ çš„è®¾å¤‡ä¸Šã€‚è®¢é˜…ï¼ˆClaude Pro/Max æˆ– OpenAI Codexï¼‰æ˜¯è¿™äº›æä¾›å•†çš„å¯é€‰è®¤è¯æ–¹å¼ã€‚
...
å¤åˆ¶å®ƒæ‰“å°çš„ä»¤ç‰Œï¼Œç„¶åŽåœ¨å‘å¯¼ä¸­é€‰æ‹© **Anthropic token (paste setup-token)**ã€‚å¦‚æžœä½ æƒ³åœ¨ Gateway ç½‘å…³ä¸»æœºä¸Šè¿è¡Œï¼Œä½¿ç”¨ `OpenKrab models auth setup-token --provider anthropic`ã€‚å¦‚æžœä½ åœ¨å…¶ä»–åœ°æ–¹è¿è¡Œäº† `claude setup-token`ï¼Œåœ¨ Gateway ç½‘å…³ä¸»æœºä¸Šä½¿ç”¨ `OpenKrab models auth paste-token --provider anthropic` ç²˜è´´ã€‚å‚é˜… [Anthropic](/providers/anthropic)ã€‚

### æ˜¯å¦æ”¯æŒ Claude è®¢é˜…è®¤è¯ï¼ˆClaude Pro/Maxï¼‰

æ˜¯çš„â€”â€”é€šè¿‡ **setup-token**ã€‚OpenKrab ä¸å†å¤ç”¨ Claude Code CLI OAuth ä»¤ç‰Œï¼›è¯·ä½¿ç”¨ setup-token æˆ– Anthropic API å¯†é’¥ã€‚åœ¨ä»»ä½•åœ°æ–¹ç”Ÿæˆä»¤ç‰Œå¹¶åœ¨ Gateway ç½‘å…³ä¸»æœºä¸Šç²˜è´´ã€‚å‚é˜… [Anthropic](/providers/anthropic) å’Œ [OAuth](/concepts/oauth)ã€‚
...
æç¤ºï¼šè®¾ç½®ä¸€ä¸ª**å¤‡ç”¨æ¨¡åž‹**ï¼Œè¿™æ · OpenKrab åœ¨æŸä¸ªæä¾›å•†è¢«é™é€Ÿæ—¶ä»èƒ½ç»§ç»­å›žå¤ã€‚
...
OpenKrab é€šè¿‡ OAuthï¼ˆChatGPT ç™»å½•ï¼‰æ”¯æŒ **OpenAI Code (Codex)**ã€‚å‘å¯¼å¯ä»¥è¿è¡Œ OAuth æµç¨‹ï¼Œå¹¶åœ¨é€‚å½“æ—¶å°†é»˜è®¤æ¨¡åž‹è®¾ç½®ä¸º `openai-codex/gpt-5.2`ã€‚å‚é˜…[æ¨¡åž‹æä¾›å•†](/concepts/model-providers)å’Œ[å‘å¯¼](/start/wizard)ã€‚

### æ˜¯å¦æ”¯æŒ OpenAI è®¢é˜…è®¤è¯ï¼ˆCodex OAuthï¼‰

æ˜¯çš„ã€‚OpenKrab å®Œå…¨æ”¯æŒ **OpenAI Code (Codex) è®¢é˜… OAuth**ã€‚æ–°æ‰‹å¼•å¯¼å‘å¯¼å¯ä»¥ä¸ºä½ è¿è¡Œ OAuth æµç¨‹ã€‚

å‚é˜… [OAuth](/concepts/oauth)ã€[æ¨¡åž‹æä¾›å•†](/concepts/model-providers)å’Œ[å‘å¯¼](/start/wizard)ã€‚

### å¦‚ä½•è®¾ç½® Gemini CLI OAuth

Gemini CLI ä½¿ç”¨**æ’ä»¶è®¤è¯æµç¨‹**ï¼Œè€Œä¸æ˜¯ `OpenKrab.json` ä¸­çš„ client id æˆ– secretã€‚

æ­¥éª¤ï¼š

1. å¯ç”¨æ’ä»¶ï¼š`OpenKrab plugins enable google-gemini-cli-auth`
2. ç™»å½•ï¼š`OpenKrab models auth login --provider google-gemini-cli --set-default`
...
é€šå¸¸ä¸é€‚åˆã€‚OpenKrab éœ€è¦å¤§ä¸Šä¸‹æ–‡ + å¼ºå®‰å…¨æ€§ï¼›å°æ˜¾å¡ä¼šæˆªæ–­ä¸”æ³„æ¼ã€‚å¦‚æžœå¿…é¡»ä½¿ç”¨ï¼Œè¯·åœ¨æœ¬åœ°è¿è¡Œä½ èƒ½è¿è¡Œçš„**æœ€å¤§** MiniMax M2.1 ç‰ˆæœ¬ï¼ˆLM Studioï¼‰ï¼Œå‚é˜… [/gateway/local-models](/gateway/local-models)ã€‚è¾ƒå°/é‡åŒ–çš„æ¨¡åž‹ä¼šå¢žåŠ æç¤ºæ³¨å…¥é£Žé™©â€”â€”å‚é˜…[å®‰å…¨](/gateway/security)ã€‚
...
ä¸éœ€è¦ã€‚OpenKrab è¿è¡Œåœ¨ macOS æˆ– Linux ä¸Šï¼ˆWindows é€šè¿‡ WSL2ï¼‰ã€‚Mac mini æ˜¯å¯é€‰çš„â€”â€”æœ‰äº›äººä¹°ä¸€å°ä½œä¸ºå¸¸å¼€ä¸»æœºï¼Œä½†å°åž‹ VPSã€å®¶åº­æœåŠ¡å™¨æˆ– Raspberry Pi çº§åˆ«çš„è®¾å¤‡ä¹Ÿå¯ä»¥ã€‚
...
ä½ éœ€è¦**æŸå°ç™»å½•äº† Messages çš„ macOS è®¾å¤‡**ã€‚å®ƒ**ä¸ä¸€å®š**æ˜¯ Mac miniâ€”â€”ä»»ä½• Mac éƒ½å¯ä»¥ã€‚OpenKrab çš„ iMessage é›†æˆåœ¨ macOS ä¸Šè¿è¡Œï¼ˆBlueBubbles æˆ– `imsg`ï¼‰ï¼Œè€Œ Gateway ç½‘å…³å¯ä»¥åœ¨å…¶ä»–åœ°æ–¹è¿è¡Œã€‚
...
### å¦‚æžœæˆ‘ä¹°äº† Mac mini è¿è¡Œ OpenKrabï¼Œèƒ½è¿žæŽ¥åˆ°æˆ‘çš„ MacBook Pro å—
...
- ä½¿ç”¨ `OpenKrab nodes status` / `OpenKrab nodes list` æŸ¥çœ‹å®ƒã€‚
...
- ç»™ä½ çš„æœºå™¨äººå‘ç§ä¿¡ï¼Œç„¶åŽè¿è¡Œ `OpenKrab logs --follow` å¹¶è¯»å– `from.id`ã€‚
...
### å¤šäººèƒ½å¦ä½¿ç”¨åŒä¸€ä¸ª WhatsApp å·ç é…åˆä¸åŒçš„ OpenKrab å®žä¾‹
...
å¦‚æžœä½ é€šè¿‡ systemd è¿è¡Œ OpenKrabï¼Œç¡®ä¿æœåŠ¡ PATH åŒ…å« `/home/linuxbrew/.linuxbrew/bin`ï¼ˆæˆ–ä½ çš„ brew å‰ç¼€ï¼‰ï¼Œä»¥ä¾¿ `brew` å®‰è£…çš„å·¥å…·åœ¨éžç™»å½• shell ä¸­å¯è§£æžã€‚
...
è¿™**ä¸ä¼šåˆ é™¤ä½ çš„æ•°æ®**â€”â€”å®ƒåªæ”¹å˜ OpenKrab ä»£ç çš„å®‰è£…ä½ç½®ã€‚ä½ çš„çŠ¶æ€
ï¼ˆ`~/.OpenKrab`ï¼‰å’Œå·¥ä½œåŒºï¼ˆ`~/.OpenKrab/workspace`ï¼‰ä¿æŒä¸å˜ã€‚
...
**OpenKrab ç‰¹å®šè¯´æ˜Žï¼š** WhatsApp/Telegram/Slack/Mattermostï¼ˆæ’ä»¶ï¼‰/Discord åœ¨ VPS ä¸Šéƒ½èƒ½æ­£å¸¸å·¥ä½œã€‚å”¯ä¸€çš„çœŸæ­£æƒè¡¡æ˜¯**æ— å¤´æµè§ˆå™¨**ä¸Žå¯è§çª—å£ã€‚å‚é˜…[æµè§ˆå™¨](/tools/browser)ã€‚
...
### åœ¨ä¸“ç”¨æœºå™¨ä¸Šè¿è¡Œ OpenKrab æœ‰å¤šé‡è¦
...
OpenKrab æ˜¯è½»é‡çº§çš„ã€‚å¯¹äºŽåŸºæœ¬çš„ Gateway ç½‘å…³ + ä¸€ä¸ªèŠå¤©æ¸ é“ï¼š
...
### å¯ä»¥åœ¨è™šæ‹Ÿæœºä¸­è¿è¡Œ OpenKrab å—ï¼Ÿæœ‰ä»€ä¹ˆè¦æ±‚
...
### ç”¨ä¸€æ®µè¯æè¿° OpenKrab

OpenKrab æ˜¯ä¸€ä¸ªè¿è¡Œåœ¨ä½ è‡ªå·±è®¾å¤‡ä¸Šçš„ä¸ªäºº AI åŠ©æ‰‹ã€‚å®ƒåœ¨ä½ å·²ç»ä½¿ç”¨çš„æ¶ˆæ¯å¹³å°ä¸Šå›žå¤ï¼ˆWhatsAppã€Telegramã€Slackã€Mattermostï¼ˆæ’ä»¶ï¼‰ã€Discordã€Google Chatã€Signalã€iMessageã€WebChatï¼‰ï¼Œè¿˜å¯ä»¥åœ¨æ”¯æŒçš„å¹³å°ä¸Šè¿›è¡Œè¯­éŸ³å’Œå®žæ—¶ Canvasã€‚**Gateway ç½‘å…³** æ˜¯å¸¸å¼€çš„æŽ§åˆ¶å¹³é¢ï¼›åŠ©æ‰‹æ˜¯äº§å“ã€‚

### ä»·å€¼ä¸»å¼ æ˜¯ä»€ä¹ˆ

OpenKrab ä¸æ˜¯â€œåªæ˜¯ä¸€ä¸ª Claude åŒ…è£…å™¨â€ã€‚å®ƒæ˜¯ä¸€ä¸ª**æœ¬åœ°ä¼˜å…ˆçš„æŽ§åˆ¶å¹³é¢**ï¼Œè®©ä½ åœ¨**è‡ªå·±çš„ç¡¬ä»¶**ä¸Šè¿è¡Œå¼ºå¤§çš„åŠ©æ‰‹ï¼Œå¯ä»Žä½ å·²ç»ä½¿ç”¨çš„èŠå¤©åº”ç”¨è®¿é—®ï¼Œå…·æœ‰æœ‰çŠ¶æ€ä¼šè¯ã€è®°å¿†å’Œå·¥å…·â€”â€”æ— éœ€å°†å·¥ä½œæµç¨‹çš„æŽ§åˆ¶æƒäº¤ç»™æ‰˜ç®¡ SaaSã€‚
...
### OpenKrab æ—¥å¸¸æœ€å¸¸ç”¨çš„äº”ä¸ªåœºæ™¯æ˜¯ä»€ä¹ˆ
...
### OpenKrab èƒ½å¦å¸®åŠ© SaaS è¿›è¡ŒèŽ·å®¢ã€å¤–è”ã€å¹¿å‘Šå’Œåšå®¢

å¯ä»¥ç”¨äºŽ**è°ƒç ”ã€ç­›é€‰å’Œèµ·è‰**ã€‚å®ƒå¯ä»¥æ‰«æç½‘ç«™ã€å»ºç«‹å€™é€‰åå•ã€æ€»ç»“æ½œåœ¨å®¢æˆ·ï¼Œå¹¶æ’°å†™å¤–è”æˆ–å¹¿å‘Šæ–‡æ¡ˆè‰ç¨¿ã€‚

å¯¹äºŽ**å¤–è”æˆ–å¹¿å‘ŠæŠ•æ”¾**ï¼Œè¯·ä¿æŒäººå·¥å®¡æ ¸ã€‚é¿å…åžƒåœ¾é‚®ä»¶ï¼Œéµå®ˆå½“åœ°æ³•å¾‹å’Œå¹³å°æ”¿ç­–ï¼Œåœ¨å‘é€ä¹‹å‰å®¡æŸ¥æ‰€æœ‰å†…å®¹ã€‚æœ€å®‰å…¨çš„æ¨¡å¼æ˜¯è®© OpenKrab èµ·è‰ï¼Œç”±ä½ æ‰¹å‡†ã€‚

æ–‡æ¡£ï¼š[å®‰å…¨](/gateway/security)ã€‚

### ç›¸æ¯” Claude Codeï¼Œåœ¨ Web å¼€å‘æ–¹é¢æœ‰ä»€ä¹ˆä¼˜åŠ¿

OpenKrab æ˜¯ä¸€ä¸ª**ä¸ªäººåŠ©æ‰‹**å’Œåè°ƒå±‚ï¼Œä¸æ˜¯ IDE æ›¿ä»£å“ã€‚ä½¿ç”¨ Claude Code æˆ– Codex åœ¨ä»“åº“ä¸­è¿›è¡Œæœ€å¿«çš„ç›´æŽ¥ç¼–ç å¾ªçŽ¯ã€‚å½“ä½ éœ€è¦æŒä¹…è®°å¿†ã€è·¨è®¾å¤‡è®¿é—®å’Œå·¥å…·ç¼–æŽ’æ—¶ï¼Œä½¿ç”¨ OpenKrabã€‚
...
å±•ç¤ºï¼šhttps://OpenKrab.ai/showcase

## Skills ä¸Žè‡ªåŠ¨åŒ–

### å¦‚ä½•è‡ªå®šä¹‰ Skills è€Œä¸å¼„è„ä»“åº“

ä½¿ç”¨æ‰˜ç®¡è¦†ç›–è€Œä¸æ˜¯ç¼–è¾‘ä»“åº“å‰¯æœ¬ã€‚å°†ä½ çš„æ›´æ”¹æ”¾åœ¨ `~/.OpenKrab/skills/<name>/SKILL.md`ï¼ˆæˆ–é€šè¿‡ `~/.OpenKrab/OpenKrab.json` ä¸­çš„ `skills.load.extraDirs` æ·»åŠ æ–‡ä»¶å¤¹ï¼‰ã€‚ä¼˜å…ˆçº§æ˜¯ `<workspace>/skills` > `~/.OpenKrab/skills` > å†…ç½®ï¼Œæ‰€ä»¥æ‰˜ç®¡è¦†ç›–ä¼˜å…ˆç”Ÿæ•ˆè€Œä¸ä¼šä¿®æ”¹ gitã€‚åªæœ‰å€¼å¾—ä¸Šæ¸¸åˆå¹¶çš„ç¼–è¾‘æ‰åº”è¯¥æ”¾åœ¨ä»“åº“ä¸­å¹¶ä½œä¸º PR æäº¤ã€‚

### å¯ä»¥ä»Žè‡ªå®šä¹‰æ–‡ä»¶å¤¹åŠ è½½ Skills å—

å¯ä»¥ã€‚é€šè¿‡ `~/.OpenKrab/OpenKrab.json` ä¸­çš„ `skills.load.extraDirs` æ·»åŠ é¢å¤–ç›®å½•ï¼ˆæœ€ä½Žä¼˜å…ˆçº§ï¼‰ã€‚é»˜è®¤ä¼˜å…ˆçº§ä¿æŒä¸å˜ï¼š`<workspace>/skills` â†’ `~/.OpenKrab/skills` â†’ å†…ç½® â†’ `skills.load.extraDirs`ã€‚`KrabHub` é»˜è®¤å®‰è£…åˆ° `./skills`ï¼ŒOpenKrab å°†å…¶è§†ä¸º `<workspace>/skills`ã€‚
...
- ç¡®è®¤ cron å·²å¯ç”¨ï¼ˆ`cron.enabled`ï¼‰ä¸”æœªè®¾ç½® `OPENKRAB_SKIP_CRON`ã€‚
...
ä½¿ç”¨ **KrabHub**ï¼ˆCLIï¼‰æˆ–å°† Skills æ”¾å…¥ä½ çš„å·¥ä½œåŒºã€‚macOS Skills UI åœ¨ Linux ä¸Šä¸å¯ç”¨ã€‚
æµè§ˆ Skillsï¼šhttps://KrabHub.comã€‚

å®‰è£… KrabHub CLIï¼ˆé€‰æ‹©ä¸€ä¸ªåŒ…ç®¡ç†å™¨ï¼‰ï¼š
...
### OpenKrab èƒ½å¦æŒ‰è®¡åˆ’æˆ–åœ¨åŽå°æŒç»­è¿è¡Œä»»åŠ¡
...
ä¸èƒ½ç›´æŽ¥è¿è¡Œã€‚macOS Skills å— `metadata.OpenKrab.os` å’Œæ‰€éœ€äºŒè¿›åˆ¶æ–‡ä»¶é™åˆ¶ï¼ŒSkills åªæœ‰åœ¨ **Gateway ç½‘å…³ä¸»æœº**ä¸Šç¬¦åˆæ¡ä»¶æ—¶æ‰ä¼šå‡ºçŽ°åœ¨ç³»ç»Ÿæç¤ºä¸­ã€‚åœ¨ Linux ä¸Šï¼Œ`darwin` ä¸“ç”¨ Skillsï¼ˆå¦‚ `apple-notes`ã€`apple-reminders`ã€`things-mac`ï¼‰ä¸ä¼šåŠ è½½ï¼Œé™¤éžä½ è¦†ç›–é™åˆ¶ã€‚

ä½ æœ‰ä¸‰ç§æ”¯æŒçš„æ¨¡å¼ï¼š

**æ–¹æ¡ˆ A - åœ¨ Mac ä¸Šè¿è¡Œ Gateway ç½‘å…³ï¼ˆæœ€ç®€å•ï¼‰ã€‚**
åœ¨ macOS äºŒè¿›åˆ¶æ–‡ä»¶æ‰€åœ¨çš„åœ°æ–¹è¿è¡Œ Gateway ç½‘å…³ï¼Œç„¶åŽä»Ž Linux é€šè¿‡[è¿œç¨‹æ¨¡å¼](#how-do-i-run-OpenKrab-in-remote-mode-client-connects-to-a-gateway-elsewhere)æˆ– Tailscale è¿žæŽ¥ã€‚Skills æ­£å¸¸åŠ è½½ï¼Œå› ä¸º Gateway ç½‘å…³ä¸»æœºæ˜¯ macOSã€‚

**æ–¹æ¡ˆ B - ä½¿ç”¨ macOS èŠ‚ç‚¹ï¼ˆæ— éœ€ SSHï¼‰ã€‚**
åœ¨ Linux ä¸Šè¿è¡Œ Gateway ç½‘å…³ï¼Œé…å¯¹ä¸€ä¸ª macOS èŠ‚ç‚¹ï¼ˆèœå•æ åº”ç”¨ï¼‰ï¼Œå¹¶åœ¨ Mac ä¸Šå°†**èŠ‚ç‚¹è¿è¡Œå‘½ä»¤**è®¾ç½®ä¸ºâ€œå§‹ç»ˆè¯¢é—®â€æˆ–â€œå§‹ç»ˆå…è®¸â€ã€‚å½“æ‰€éœ€äºŒè¿›åˆ¶æ–‡ä»¶å­˜åœ¨äºŽèŠ‚ç‚¹ä¸Šæ—¶ï¼ŒOpenKrab å¯ä»¥å°† macOS ä¸“ç”¨ Skills è§†ä¸ºç¬¦åˆæ¡ä»¶ã€‚æ™ºèƒ½ä½“é€šè¿‡ `nodes` å·¥å…·è¿è¡Œè¿™äº› Skillsã€‚å¦‚æžœä½ é€‰æ‹©â€œå§‹ç»ˆè¯¢é—®â€ï¼Œåœ¨æç¤ºä¸­æ‰¹å‡†â€œå§‹ç»ˆå…è®¸â€ä¼šå°†è¯¥å‘½ä»¤æ·»åŠ åˆ°å…è®¸åˆ—è¡¨ã€‚
...
3. è¦†ç›– Skills å…ƒæ•°æ®ï¼ˆå·¥ä½œåŒºæˆ– `~/.OpenKrab/skills`ï¼‰ä»¥å…è®¸ Linuxï¼š
   ```markdown
   ---
   name: imsg
   description: iMessage/SMS CLI for listing chats, history, watch, and sending.
   metadata: { "OpenKrab": { "os": ["darwin", "linux"], "requires": { "bins": ["imsg"] } } }
   ---
   ```
4. å¼€å§‹æ–°ä¼šè¯ä»¥åˆ·æ–° Skills å¿«ç…§ã€‚

å¯¹äºŽ iMessageï¼Œä½ ä¹Ÿå¯ä»¥å°† `channels.imessage.cliPath` æŒ‡å‘ SSH åŒ…è£…å™¨ï¼ˆOpenKrab åªéœ€è¦ stdioï¼‰ã€‚å‚é˜… [iMessage](/channels/imessage)ã€‚
...
KrabHub å®‰è£…åˆ°å½“å‰ç›®å½•ä¸‹çš„ `./skills`ï¼ˆæˆ–å›žé€€åˆ°ä½ é…ç½®çš„ OpenKrab å·¥ä½œåŒºï¼‰ï¼›OpenKrab åœ¨ä¸‹ä¸€ä¸ªä¼šè¯ä¸­å°†å…¶è§†ä¸º `<workspace>/skills`ã€‚å¯¹äºŽè·¨æ™ºèƒ½ä½“å…±äº«çš„ Skillsï¼Œå°†å®ƒä»¬æ”¾åœ¨ `~/.OpenKrab/skills/<name>/SKILL.md`ã€‚æŸäº› Skills æœŸæœ›é€šè¿‡ Homebrew å®‰è£…äºŒè¿›åˆ¶æ–‡ä»¶ï¼›åœ¨ Linux ä¸Šæ„å‘³ç€ Linuxbrewï¼ˆå‚é˜…ä¸Šé¢çš„ Homebrew Linux å¸¸è§é—®é¢˜æ¡ç›®ï¼‰ã€‚å‚é˜…[Skills](/tools/skills)å’Œ [KrabHub](/tools/KrabHub)ã€‚
...
OpenKrab è®°å¿†å°±æ˜¯æ™ºèƒ½ä½“å·¥ä½œåŒºä¸­çš„ Markdown æ–‡ä»¶ï¼š

- æ¯æ—¥ç¬”è®°åœ¨ `memory/YYYY-MM-DD.md`
- ç²¾é€‰çš„é•¿æœŸç¬”è®°åœ¨ `MEMORY.md`ï¼ˆä»…é™ä¸»/ç§å¯†ä¼šè¯ï¼‰

OpenKrab è¿˜ä¼šè¿è¡Œ**é™é»˜çš„é¢„åŽ‹ç¼©è®°å¿†åˆ·æ–°**ï¼Œä»¥æé†’æ¨¡åž‹åœ¨è‡ªåŠ¨åŽ‹ç¼©ä¹‹å‰å†™å…¥æŒä¹…ç¬”è®°ã€‚è¿™åªåœ¨å·¥ä½œåŒºå¯å†™æ—¶è¿è¡Œï¼ˆåªè¯»æ²™ç®±ä¼šè·³è¿‡ï¼‰ã€‚å‚é˜…[è®°å¿†](/concepts/memory)ã€‚
...
å¦‚æžœä½ æ²¡æœ‰æ˜Žç¡®è®¾ç½®æä¾›å•†ï¼ŒOpenKrab ä¼šåœ¨èƒ½è§£æž API å¯†é’¥ï¼ˆè®¤è¯é…ç½®æ–‡ä»¶ã€`models.providers.*.apiKey` æˆ–çŽ¯å¢ƒå˜é‡ï¼‰æ—¶è‡ªåŠ¨é€‰æ‹©æä¾›å•†ã€‚å¦‚æžœ OpenAI å¯†é’¥å¯è§£æžåˆ™ä¼˜å…ˆä½¿ç”¨ OpenAIï¼Œå¦åˆ™å¦‚æžœ Gemini å¯†é’¥å¯è§£æžåˆ™ä½¿ç”¨ Geminiã€‚å¦‚æžœä¸¤ä¸ªå¯†é’¥éƒ½ä¸å¯ç”¨ï¼Œè®°å¿†æœç´¢ä¿æŒç¦ç”¨ç›´åˆ°ä½ é…ç½®å®ƒã€‚å¦‚æžœä½ é…ç½®äº†æœ¬åœ°æ¨¡åž‹è·¯å¾„ä¸”å­˜åœ¨ï¼ŒOpenKrab ä¼˜å…ˆä½¿ç”¨ `local`ã€‚
...
### OpenKrab ä½¿ç”¨çš„æ‰€æœ‰æ•°æ®éƒ½ä¿å­˜åœ¨æœ¬åœ°å—

ä¸æ˜¯â€”â€”**OpenKrab çš„çŠ¶æ€æ˜¯æœ¬åœ°çš„**ï¼Œä½†**å¤–éƒ¨æœåŠ¡ä»ç„¶ä¼šçœ‹åˆ°ä½ å‘é€ç»™å®ƒä»¬çš„å†…å®¹**ã€‚

- **é»˜è®¤æœ¬åœ°ï¼š** ä¼šè¯ã€è®°å¿†æ–‡ä»¶ã€é…ç½®å’Œå·¥ä½œåŒºä½äºŽ Gateway ç½‘å…³ä¸»æœºä¸Šï¼ˆ`~/.OpenKrab` + ä½ çš„å·¥ä½œåŒºç›®å½•ï¼‰ã€‚
...
### OpenKrab å°†æ•°æ®å­˜å‚¨åœ¨å“ªé‡Œ

æ‰€æœ‰å†…å®¹ä½äºŽ `$OPENKRAB_STATE_DIR`ï¼ˆé»˜è®¤ï¼š`~/.OpenKrab`ï¼‰ä¸‹ï¼š

| è·¯å¾„                                                            | ç”¨é€”                                                 |
| --------------------------------------------------------------- | ---------------------------------------------------- |
| `$OPENKRAB_STATE_DIR/OpenKrab.json`                             | ä¸»é…ç½®ï¼ˆJSON5ï¼‰                                      |
| `$OPENKRAB_STATE_DIR/credentials/oauth.json`                    | æ—§ç‰ˆ OAuth å¯¼å…¥ï¼ˆé¦–æ¬¡ä½¿ç”¨æ—¶å¤åˆ¶åˆ°è®¤è¯é…ç½®æ–‡ä»¶ï¼‰      |
| `$OPENKRAB_STATE_DIR/agents/<agentId>/agent/auth-profiles.json` | è®¤è¯é…ç½®æ–‡ä»¶ï¼ˆOAuth + API å¯†é’¥ï¼‰                     |
| `$OPENKRAB_STATE_DIR/agents/<agentId>/agent/auth.json`          | è¿è¡Œæ—¶è®¤è¯ç¼“å­˜ï¼ˆè‡ªåŠ¨ç®¡ç†ï¼‰                           |
| `$OPENKRAB_STATE_DIR/credentials/`                              | æä¾›å•†çŠ¶æ€ï¼ˆä¾‹å¦‚ `whatsapp/<accountId>/creds.json`ï¼‰ |
| `$OPENKRAB_STATE_DIR/agents/`                                   | æŒ‰æ™ºèƒ½ä½“çš„çŠ¶æ€ï¼ˆagentDir + ä¼šè¯ï¼‰                    |
| `$OPENKRAB_STATE_DIR/agents/<agentId>/sessions/`                | å¯¹è¯åŽ†å²å’ŒçŠ¶æ€ï¼ˆæŒ‰æ™ºèƒ½ä½“ï¼‰                           |
| `$OPENKRAB_STATE_DIR/agents/<agentId>/sessions/sessions.json`   | ä¼šè¯å…ƒæ•°æ®ï¼ˆæŒ‰æ™ºèƒ½ä½“ï¼‰                               |

æ—§ç‰ˆå•æ™ºèƒ½ä½“è·¯å¾„ï¼š`~/.OpenKrab/agent/*`ï¼ˆé€šè¿‡ `OpenKrab doctor` è¿ç§»ï¼‰ã€‚

ä½ çš„**å·¥ä½œåŒº**ï¼ˆAGENTS.mdã€è®°å¿†æ–‡ä»¶ã€Skills ç­‰ï¼‰æ˜¯ç‹¬ç«‹çš„ï¼Œé€šè¿‡ `agents.defaults.workspace` é…ç½®ï¼ˆé»˜è®¤ï¼š`~/.OpenKrab/workspace`ï¼‰ã€‚

### AGENTS.md / SOUL.md / USER.md / MEMORY.md åº”è¯¥æ”¾åœ¨å“ªé‡Œ

è¿™äº›æ–‡ä»¶ä½äºŽ**æ™ºèƒ½ä½“å·¥ä½œåŒº**ä¸­ï¼Œè€Œä¸æ˜¯ `~/.OpenKrab`ã€‚
...
- **çŠ¶æ€ç›®å½•ï¼ˆ`~/.OpenKrab`ï¼‰**ï¼šé…ç½®ã€å‡­æ®ã€è®¤è¯é…ç½®æ–‡ä»¶ã€ä¼šè¯ã€æ—¥å¿—å’Œå…±äº« Skillsï¼ˆ`~/.OpenKrab/skills`ï¼‰ã€‚

é»˜è®¤å·¥ä½œåŒºæ˜¯ `~/.OpenKrab/workspace`ï¼Œå¯é€šè¿‡ä»¥ä¸‹æ–¹å¼é…ç½®ï¼š
...
**ä¸è¦**æäº¤ `~/.OpenKrab` ä¸‹çš„ä»»ä½•å†…å®¹ï¼ˆå‡­æ®ã€ä¼šè¯ã€ä»¤ç‰Œï¼‰ã€‚å¦‚æžœä½ éœ€è¦å®Œæ•´æ¢å¤ï¼Œå°†å·¥ä½œåŒºå’ŒçŠ¶æ€ç›®å½•åˆ†åˆ«å¤‡ä»½ï¼ˆå‚é˜…ä¸Šé¢çš„è¿ç§»é—®é¢˜ï¼‰ã€‚

æ–‡æ¡£ï¼š[æ™ºèƒ½ä½“å·¥ä½œåŒº](/concepts/agent-workspace)ã€‚

### å¦‚ä½•å®Œå…¨å¸è½½ OpenKrab

å‚é˜…ä¸“é—¨æŒ‡å—ï¼š[å¸è½½](/install/uninstall)ã€‚

### æ™ºèƒ½ä½“å¯ä»¥åœ¨å·¥ä½œåŒºå¤–å·¥ä½œå—

å¯ä»¥ã€‚å·¥ä½œåŒºæ˜¯**é»˜è®¤ cwd** å’Œè®°å¿†é”šç‚¹ï¼Œä¸æ˜¯ç¡¬æ²™ç®±ã€‚ç›¸å¯¹è·¯å¾„åœ¨å·¥ä½œåŒºå†…è§£æžï¼Œä½†ç»å¯¹è·¯å¾„å¯ä»¥è®¿é—®å…¶ä»–ä¸»æœºä½ç½®ï¼Œé™¤éžå¯ç”¨äº†æ²™ç®±ã€‚å¦‚æžœä½ éœ€è¦éš”ç¦»ï¼Œä½¿ç”¨ [`agents.defaults.sandbox`](/gateway/sandboxing) æˆ–æŒ‰æ™ºèƒ½ä½“çš„æ²™ç®±è®¾ç½®ã€‚å¦‚æžœä½ å¸Œæœ›æŸä¸ªä»“åº“ä½œä¸ºé»˜è®¤å·¥ä½œç›®å½•ï¼Œå°†è¯¥æ™ºèƒ½ä½“çš„ `workspace` æŒ‡å‘ä»“åº“æ ¹ç›®å½•ã€‚OpenKrab ä»“åº“åªæ˜¯æºä»£ç ï¼›é™¤éžä½ æœ‰æ„è¦è®©æ™ºèƒ½ä½“åœ¨å…¶ä¸­å·¥ä½œï¼Œå¦åˆ™ä¿æŒå·¥ä½œåŒºç‹¬ç«‹ã€‚
...
OpenKrab ä»Ž `$OPENKRAB_CONFIG_PATH`ï¼ˆé»˜è®¤ï¼š`~/.OpenKrab/OpenKrab.json`ï¼‰è¯»å–å¯é€‰çš„ **JSON5** é…ç½®ï¼š

```
$OPENKRAB_CONFIG_PATH
```

å¦‚æžœæ–‡ä»¶ä¸å­˜åœ¨ï¼Œä½¿ç”¨å®‰å…¨çš„é»˜è®¤å€¼ï¼ˆåŒ…æ‹¬é»˜è®¤å·¥ä½œåŒº `~/.OpenKrab/workspace`ï¼‰ã€‚

### æˆ‘è®¾ç½®äº† gateway.bind: "lan"ï¼ˆæˆ– "tailnet"ï¼‰ï¼ŒçŽ°åœ¨ä»€ä¹ˆéƒ½ç›‘å¬ä¸äº† / UI æ˜¾ç¤ºæœªæŽˆæƒ

éž local loopback ç»‘å®š**éœ€è¦è®¤è¯**ã€‚é…ç½® `gateway.auth.mode` + `gateway.auth.token`ï¼ˆæˆ–ä½¿ç”¨ `OPENKRAB_GATEWAY_TOKEN`ï¼‰ã€‚
...
å¦‚æžœä½ **ç¡®å®ž**æƒ³è¦å¼€æ”¾ local loopbackï¼Œä»Žé…ç½®ä¸­ç§»é™¤ `gateway.auth`ã€‚Doctor å¯ä»¥éšæ—¶ä¸ºä½ ç”Ÿæˆä»¤ç‰Œï¼š`OpenKrab doctor --generate-gateway-token`ã€‚
...
`web_fetch` æ— éœ€ API å¯†é’¥å³å¯å·¥ä½œã€‚`web_search` éœ€è¦ Brave Search API å¯†é’¥ã€‚**æŽ¨èï¼š** è¿è¡Œ `OpenKrab configure --section web` å°†å…¶å­˜å‚¨åœ¨ `tools.web.search.apiKey` ä¸­ã€‚çŽ¯å¢ƒå˜é‡æ›¿ä»£æ–¹æ¡ˆï¼šä¸º Gateway ç½‘å…³è¿›ç¨‹è®¾ç½® `BRAVE_API_KEY`ã€‚
...
- å®ˆæŠ¤è¿›ç¨‹ä»Ž `~/.OpenKrab/.env`ï¼ˆæˆ–æœåŠ¡çŽ¯å¢ƒï¼‰è¯»å–çŽ¯å¢ƒå˜é‡ã€‚
...
- ä»Žå¤‡ä»½æ¢å¤ï¼ˆgit æˆ–å¤åˆ¶çš„ `~/.OpenKrab/OpenKrab.json`ï¼‰ã€‚
- å¦‚æžœæ²¡æœ‰å¤‡ä»½ï¼Œé‡æ–°è¿è¡Œ `OpenKrab doctor` å¹¶é‡æ–°é…ç½®æ¸ é“/æ¨¡åž‹ã€‚
...
- å¯¹å°æ›´æ”¹ä½¿ç”¨ `OpenKrab config set`ã€‚
- å¯¹äº¤äº’å¼ç¼–è¾‘ä½¿ç”¨ `OpenKrab configure`ã€‚
...
### OpenKrab æµè§ˆå™¨å¯ä»¥æ— å¤´è¿è¡Œå—
...
- Gateway ç½‘å…³æ­£åœ¨è¿è¡Œï¼š`OpenKrab gateway status`
- Gateway ç½‘å…³å¥åº·ï¼š`OpenKrab status`
- æ¸ é“å¥åº·ï¼š`OpenKrab channels status`
...
### ä¸¤ä¸ª OpenKrab å®žä¾‹ï¼ˆæœ¬åœ° + VPSï¼‰å¯ä»¥äº’ç›¸é€šä¿¡å—
...
**CLI æ¡¥æŽ¥ï¼ˆé€šç”¨ï¼‰ï¼š** è¿è¡Œä¸€ä¸ªè„šæœ¬è°ƒç”¨å¦ä¸€ä¸ª Gateway ç½‘å…³ï¼Œä½¿ç”¨ `OpenKrab agent --message ... --deliver`ï¼Œå®šå‘åˆ°å¦ä¸€ä¸ªæœºå™¨äººç›‘å¬çš„èŠå¤©ã€‚å¦‚æžœä¸€ä¸ªæœºå™¨äººåœ¨è¿œç¨‹ VPS ä¸Šï¼Œé€šè¿‡ SSH/Tailscale å°†ä½ çš„ CLI æŒ‡å‘è¯¥è¿œç¨‹ Gateway ç½‘å…³ï¼ˆå‚é˜…[è¿œç¨‹è®¿é—®](/gateway/remote)ï¼‰ã€‚
...
### OpenKrab å¦‚ä½•åŠ è½½çŽ¯å¢ƒå˜é‡

OpenKrab ä»Žçˆ¶è¿›ç¨‹ï¼ˆshellã€launchd/systemdã€CI ç­‰ï¼‰è¯»å–çŽ¯å¢ƒå˜é‡ï¼Œå¹¶é¢å¤–åŠ è½½ï¼š

- å½“å‰å·¥ä½œç›®å½•ä¸‹çš„ `.env`
- `~/.OpenKrab/.env`ï¼ˆå³ `$OPENKRAB_STATE_DIR/.env`ï¼‰çš„å…¨å±€å›žé€€ `.env`
...
1. å°†ç¼ºå¤±çš„å¯†é’¥æ”¾åœ¨ `~/.OpenKrab/.env` ä¸­ï¼Œè¿™æ ·å³ä½¿æœåŠ¡ä¸ç»§æ‰¿ä½ çš„ shell çŽ¯å¢ƒä¹Ÿèƒ½è¢«èŽ·å–ã€‚
...
`OPENKRAB_LOAD_SHELL_ENV=1`ã€`OPENKRAB_SHELL_ENV_TIMEOUT_MS=15000`ã€‚

### æˆ‘è®¾ç½®äº† COPILOT_GITHUB_TOKENï¼Œä½† models status æ˜¾ç¤º"Shell env: off"ï¼Œä¸ºä»€ä¹ˆ

`OpenKrab models status` æŠ¥å‘Šçš„æ˜¯ **shell çŽ¯å¢ƒå¯¼å…¥**æ˜¯å¦å¯ç”¨ã€‚"Shell env: off"**ä¸**æ„å‘³ç€ä½ çš„çŽ¯å¢ƒå˜é‡ç¼ºå¤±â€”â€”å®ƒåªæ„å‘³ç€ OpenKrab ä¸ä¼šè‡ªåŠ¨åŠ è½½ä½ çš„ç™»å½• shellã€‚

å¦‚æžœ Gateway ç½‘å…³ä½œä¸ºæœåŠ¡ï¼ˆlaunchd/systemdï¼‰è¿è¡Œï¼Œå®ƒä¸ä¼šç»§æ‰¿ä½ çš„ shell çŽ¯å¢ƒã€‚é€šè¿‡ä»¥ä¸‹æ–¹å¼ä¹‹ä¸€ä¿®å¤ï¼š

1. å°†ä»¤ç‰Œæ”¾åœ¨ `~/.OpenKrab/.env` ä¸­ï¼š
   ```
...
### èƒ½å¦åˆ›å»ºä¸€ä¸ª OpenKrab å®žä¾‹å›¢é˜Ÿâ€”â€”ä¸€ä¸ª CEO å’Œå¤šä¸ªæ™ºèƒ½ä½“
...
### å¦‚ä½•å®Œå…¨é‡ç½® OpenKrab ä½†ä¿ç•™å®‰è£…
...
- å¦‚æžœä½ ä½¿ç”¨äº†é…ç½®æ–‡ä»¶ï¼ˆ`--profile` / `OPENKRAB_PROFILE`ï¼‰ï¼Œé‡ç½®æ¯ä¸ªçŠ¶æ€ç›®å½•ï¼ˆé»˜è®¤ä¸º `~/.OpenKrab-<profile>`ï¼‰ã€‚
- å¼€å‘é‡ç½®ï¼š`OpenKrab gateway --dev --reset`ï¼ˆä»…é™å¼€å‘ï¼›æ¸…é™¤å¼€å‘é…ç½® + å‡­æ® + ä¼šè¯ + å·¥ä½œåŒºï¼‰ã€‚
...
å¦‚æžœ `HEARTBEAT.md` å­˜åœ¨ä½†å®žé™…ä¸Šä¸ºç©ºï¼ˆåªæœ‰ç©ºè¡Œå’Œ markdown æ ‡é¢˜å¦‚ `# Heading`ï¼‰ï¼ŒOpenKrab ä¼šè·³è¿‡å¿ƒè·³è¿è¡Œä»¥èŠ‚çœ API è°ƒç”¨ã€‚å¦‚æžœæ–‡ä»¶ä¸å­˜åœ¨ï¼Œå¿ƒè·³ä»ç„¶è¿è¡Œï¼Œç”±æ¨¡åž‹å†³å®šåšä»€ä¹ˆã€‚
...
ä¸éœ€è¦ã€‚OpenKrab è¿è¡Œåœ¨**ä½ è‡ªå·±çš„è´¦æˆ·**ä¸Šï¼Œæ‰€ä»¥å¦‚æžœä½ åœ¨ç¾¤ç»„ä¸­ï¼ŒOpenKrab å°±èƒ½çœ‹åˆ°å®ƒã€‚
...
### ä¸ºä»€ä¹ˆ OpenKrab ä¸åœ¨ç¾¤ç»„ä¸­å›žå¤
...
- **ç£ç›˜å¢žé•¿ï¼š** ä¼šè¯ + è®°å½•ä½äºŽ `~/.OpenKrab/agents/<agentId>/sessions/` ä¸‹ã€‚
...
- ä½¿ç”¨ `OpenKrab doctor` å‘çŽ°æ— ç”¨çš„å·¥ä½œåŒºå’Œé…ç½®æ–‡ä»¶ä¸åŒ¹é…ã€‚
...
OpenKrab çš„é»˜è®¤æ¨¡åž‹æ˜¯ä½ è®¾ç½®çš„ï¼š

```
agents.defaults.model.primary
```

æ¨¡åž‹ä»¥ `provider/model` å¼•ç”¨ï¼ˆç¤ºä¾‹ï¼š`anthropic/claude-opus-4-5`ï¼‰ã€‚å¦‚æžœä½ çœç•¥æä¾›å•†ï¼ŒOpenKrab ç›®å‰å‡è®¾ `anthropic` ä½œä¸ºä¸´æ—¶å¼ƒç”¨å›žé€€â€”â€”ä½†ä½ ä»ç„¶åº”è¯¥**æ˜Žç¡®**è®¾ç½® `provider/model`ã€‚
...
- `OpenKrab models set ...`ï¼ˆåªæ›´æ–°æ¨¡åž‹é…ç½®ï¼‰
- `OpenKrab configure --section models`ï¼ˆäº¤äº’å¼ï¼‰
- ç¼–è¾‘ `~/.OpenKrab/OpenKrab.json` ä¸­çš„ `agents.defaults.model`

é¿å…ä½¿ç”¨éƒ¨åˆ†å¯¹è±¡æ‰§è¡Œ `config.apply`ï¼Œé™¤éžä½ æ‰“ç®—æ›¿æ¢æ•´ä¸ªé…ç½®ã€‚å¦‚æžœä½ ç¡®å®žè¦†ç›–äº†é…ç½®ï¼Œä»Žå¤‡ä»½æ¢å¤æˆ–é‡æ–°è¿è¡Œ `OpenKrab doctor` æ¥ä¿®å¤ã€‚

æ–‡æ¡£ï¼š[æ¨¡åž‹](/concepts/models)ã€[Configure](/cli/configure)ã€[Config](/cli/config)ã€[Doctor](/gateway/doctor)ã€‚

### OpenKrabã€Flawd å’Œ Krill ä½¿ç”¨ä»€ä¹ˆæ¨¡åž‹

- **OpenKrab + Flawdï¼š** Anthropic Opusï¼ˆ`anthropic/claude-opus-4-5`ï¼‰â€”â€”å‚é˜… [Anthropic](/providers/anthropic)ã€‚
...
æ˜¯çš„ã€‚OpenKrab å†…ç½®äº†ä¸€äº›é»˜è®¤ç®€å†™ï¼ˆä»…åœ¨æ¨¡åž‹å­˜åœ¨äºŽ `agents.defaults.models` ä¸­æ—¶åº”ç”¨ï¼‰ï¼š
...
- è¿è¡Œ `OpenKrab agents add <id>` å¹¶åœ¨å‘å¯¼ä¸­é…ç½®è®¤è¯ã€‚
...
å†·å´æœŸé€‚ç”¨äºŽå¤±è´¥çš„é…ç½®æ–‡ä»¶ï¼ˆæŒ‡æ•°é€€é¿ï¼‰ï¼Œå› æ­¤ OpenKrab å³ä½¿åœ¨æä¾›å•†è¢«é™é€Ÿæˆ–ä¸´æ—¶å¤±è´¥æ—¶ä¹Ÿèƒ½ç»§ç»­å“åº”ã€‚
...
- **ç¡®è®¤è®¤è¯é…ç½®æ–‡ä»¶çš„ä½ç½®**ï¼ˆæ–°è·¯å¾„ vs æ—§è·¯å¾„ï¼‰
  - å½“å‰ï¼š`~/.OpenKrab/agents/<agentId>/agent/auth-profiles.json`
  - æ—§ç‰ˆï¼š`~/.OpenKrab/agent/*`ï¼ˆé€šè¿‡ `OpenKrab doctor` è¿ç§»ï¼‰
- **ç¡®è®¤çŽ¯å¢ƒå˜é‡è¢« Gateway ç½‘å…³åŠ è½½**
  - å¦‚æžœä½ åœ¨ shell ä¸­è®¾ç½®äº† `ANTHROPIC_API_KEY` ä½†é€šè¿‡ systemd/launchd è¿è¡Œ Gateway ç½‘å…³ï¼Œå®ƒå¯èƒ½ä¸ä¼šç»§æ‰¿ã€‚å°†å…¶æ”¾åœ¨ `~/.OpenKrab/.env` ä¸­æˆ–å¯ç”¨ `env.shellEnv`ã€‚
- **ç¡®ä¿ä½ ç¼–è¾‘çš„æ˜¯æ­£ç¡®çš„æ™ºèƒ½ä½“**
  - å¤šæ™ºèƒ½ä½“è®¾ç½®æ„å‘³ç€å¯èƒ½æœ‰å¤šä¸ª `auth-profiles.json` æ–‡ä»¶ã€‚
- **å®Œæ•´æ€§æ£€æŸ¥æ¨¡åž‹/è®¤è¯çŠ¶æ€**
  - ä½¿ç”¨ `OpenKrab models status` æŸ¥çœ‹å·²é…ç½®çš„æ¨¡åž‹ä»¥åŠæä¾›å•†æ˜¯å¦å·²è®¤è¯ã€‚
...
- **ä½¿ç”¨ setup-token**
  - è¿è¡Œ `claude setup-token`ï¼Œç„¶åŽç”¨ `OpenKrab models auth setup-token --provider anthropic` ç²˜è´´ã€‚
  - å¦‚æžœä»¤ç‰Œåœ¨å¦ä¸€å°æœºå™¨ä¸Šåˆ›å»ºï¼Œä½¿ç”¨ `OpenKrab models auth paste-token --provider anthropic`ã€‚
- **å¦‚æžœä½ æƒ³ä½¿ç”¨ API å¯†é’¥**
  - åœ¨ **Gateway ç½‘å…³ä¸»æœº**ä¸Šå°† `ANTHROPIC_API_KEY` æ”¾å…¥ `~/.OpenKrab/.env`ã€‚
...
å¦‚æžœä½ çš„æ¨¡åž‹é…ç½®åŒ…å« Google Gemini ä½œä¸ºå›žé€€ï¼ˆæˆ–ä½ åˆ‡æ¢åˆ°äº† Gemini ç®€å†™ï¼‰ï¼ŒOpenKrab ä¼šåœ¨æ¨¡åž‹å›žé€€æœŸé—´å°è¯•å®ƒã€‚å¦‚æžœä½ æ²¡æœ‰é…ç½® Google å‡­æ®ï¼Œä½ ä¼šçœ‹åˆ° `No API key found for provider "google"`ã€‚
...
ä¿®å¤ï¼šOpenKrab çŽ°åœ¨ä¸º Google Antigravity Claude å‰¥ç¦»æœªç­¾åçš„ thinking å—ã€‚å¦‚æžœä»ç„¶å‡ºçŽ°ï¼Œå¼€å§‹**æ–°ä¼šè¯**æˆ–ä¸ºè¯¥æ™ºèƒ½ä½“è®¾ç½® `/thinking off`ã€‚
...
OpenKrab ä½¿ç”¨æä¾›å•†å‰ç¼€çš„ IDï¼Œå¦‚ï¼š
...
å¦‚æžœæŸä¸ªé…ç½®æ–‡ä»¶å¤„äºŽçŸ­æœŸ**å†·å´**ï¼ˆé€ŸçŽ‡é™åˆ¶/è¶…æ—¶/è®¤è¯å¤±è´¥ï¼‰æˆ–è¾ƒé•¿çš„**ç¦ç”¨**çŠ¶æ€ï¼ˆè®¡è´¹/é¢åº¦ä¸è¶³ï¼‰ï¼ŒOpenKrab å¯èƒ½ä¼šä¸´æ—¶è·³è¿‡å®ƒã€‚è¦æ£€æŸ¥è¿™ä¸€ç‚¹ï¼Œè¿è¡Œ `OpenKrab models status --json` å¹¶æŸ¥çœ‹ `auth.unusableProfiles`ã€‚è°ƒä¼˜ï¼š`auth.cooldowns.billingBackoffHours*`ã€‚
...
```
--port > OPENKRAB_GATEWAY_PORT > gateway.port > é»˜è®¤ 18789
```

### ä¸ºä»€ä¹ˆ OpenKrab gateway status æ˜¾ç¤º Runtime: running ä½† RPC probe: failed
...
ä½¿ç”¨ `OpenKrab gateway status` å¹¶å…³æ³¨è¿™äº›è¡Œï¼š
...
### ä¸ºä»€ä¹ˆ OpenKrab gateway status æ˜¾ç¤º Config (cli) å’Œ Config (service) ä¸åŒ

ä½ æ­£åœ¨ç¼–è¾‘ä¸€ä¸ªé…ç½®æ–‡ä»¶ï¼Œè€ŒæœåŠ¡è¿è¡Œçš„æ˜¯å¦ä¸€ä¸ªï¼ˆé€šå¸¸æ˜¯ `--profile` / `OPENKRAB_STATE_DIR` ä¸åŒ¹é…ï¼‰ã€‚
...
OpenKrab é€šè¿‡åœ¨å¯åŠ¨æ—¶ç«‹å³ç»‘å®š WebSocket ç›‘å¬å™¨æ¥å¼ºåˆ¶è¿è¡Œæ—¶é”ï¼ˆé»˜è®¤ `ws://127.0.0.1:18789`ï¼‰ã€‚å¦‚æžœç»‘å®šå›  `EADDRINUSE` å¤±è´¥ï¼Œå®ƒä¼šæŠ›å‡º `GatewayLockError` è¡¨ç¤ºå¦ä¸€ä¸ªå®žä¾‹å·²åœ¨ç›‘å¬ã€‚

ä¿®å¤ï¼šåœæ­¢å¦ä¸€ä¸ªå®žä¾‹ï¼Œé‡Šæ”¾ç«¯å£ï¼Œæˆ–ä½¿ç”¨ `OpenKrab gateway --port <port>` è¿è¡Œã€‚

### å¦‚ä½•ä»¥è¿œç¨‹æ¨¡å¼è¿è¡Œ OpenKrabï¼ˆå®¢æˆ·ç«¯è¿žæŽ¥åˆ°å…¶ä»–ä½ç½®çš„ Gateway ç½‘å…³ï¼‰
...
- `OpenKrab gateway` ä»…åœ¨ `gateway.mode` ä¸º `local` æ—¶å¯åŠ¨ï¼ˆæˆ–ä½ ä¼ é€’è¦†ç›–æ ‡å¿—ï¼‰ã€‚
...
- æŽ§åˆ¶ UI å°†ä»¤ç‰Œå­˜å‚¨åœ¨æµè§ˆå™¨ localStorage é”® `OpenKrab.control.settings.v1` ä¸­ã€‚
- UI å¯ä»¥å¯¼å…¥ä¸€æ¬¡ `?token=...`ï¼ˆå’Œ/æˆ– `?password=...`ï¼‰ï¼Œç„¶åŽä»Ž URL ä¸­å‰¥ç¦»ã€‚

ä¿®å¤ï¼š

- æœ€å¿«ï¼š`OpenKrab dashboard`ï¼ˆæ‰“å° + å¤åˆ¶å¸¦ä»¤ç‰Œçš„é“¾æŽ¥ï¼Œå°è¯•æ‰“å¼€ï¼›å¦‚æžœæ— å¤´åˆ™æ˜¾ç¤º SSH æç¤ºï¼‰ã€‚
- å¦‚æžœä½ è¿˜æ²¡æœ‰ä»¤ç‰Œï¼š`OpenKrab doctor --generate-gateway-token`ã€‚
- å¦‚æžœæ˜¯è¿œç¨‹ï¼Œå…ˆå»ºéš§é“ï¼š`ssh -N -L 18789:127.0.0.1:18789 user@host` ç„¶åŽæ‰“å¼€ `http://127.0.0.1:18789/?token=...`ã€‚
- åœ¨ Gateway ç½‘å…³ä¸»æœºä¸Šè®¾ç½® `gateway.auth.token`ï¼ˆæˆ– `OPENKRAB_GATEWAY_TOKEN`ï¼‰ã€‚
- åœ¨æŽ§åˆ¶ UI è®¾ç½®ä¸­ç²˜è´´ç›¸åŒçš„ä»¤ç‰Œï¼ˆæˆ–ä½¿ç”¨ä¸€æ¬¡æ€§ `?token=...` é“¾æŽ¥åˆ·æ–°ï¼‰ã€‚
- ä»ç„¶å¡ä½ï¼Ÿè¿è¡Œ `OpenKrab status --all` å¹¶æŒ‰[æ•…éšœæŽ’é™¤](/gateway/troubleshooting)æ“ä½œã€‚å‚é˜…[ä»ªè¡¨æ¿](/web/dashboard)äº†è§£è®¤è¯è¯¦æƒ…ã€‚
...
- `OPENKRAB_CONFIG_PATH`ï¼ˆæ¯å®žä¾‹é…ç½®ï¼‰
- `OPENKRAB_STATE_DIR`ï¼ˆæ¯å®žä¾‹çŠ¶æ€ï¼‰
- `agents.defaults.workspace`ï¼ˆå·¥ä½œåŒºéš”ç¦»ï¼‰
- `gateway.port`ï¼ˆå”¯ä¸€ç«¯å£ï¼‰

å¿«é€Ÿè®¾ç½®ï¼ˆæŽ¨èï¼‰ï¼š

- æ¯å®žä¾‹ä½¿ç”¨ `OpenKrab --profile <name> â€¦`ï¼ˆè‡ªåŠ¨åˆ›å»º `~/.OpenKrab-<name>`ï¼‰ã€‚
- åœ¨æ¯ä¸ªé…ç½®æ–‡ä»¶é…ç½®ä¸­è®¾ç½®å”¯ä¸€çš„ `gateway.port`ï¼ˆæˆ–æ‰‹åŠ¨è¿è¡Œæ—¶ä¼  `--port`ï¼‰ã€‚
- å®‰è£…æ¯é…ç½®æ–‡ä»¶çš„æœåŠ¡ï¼š`OpenKrab --profile <name> gateway install`ã€‚

é…ç½®æ–‡ä»¶è¿˜ä¼šä¸ºæœåŠ¡åç§°æ·»åŠ åŽç¼€ï¼ˆ`bot.molt.<profile>`ï¼›æ—§ç‰ˆ `com.OpenKrab.*`ã€`OpenKrab-gateway-<profile>.service`ã€`OpenKrab Gateway ç½‘å…³ (<profile>)`ï¼‰ã€‚
...
- macOSï¼š`$OPENKRAB_STATE_DIR/logs/gateway.log` å’Œ `gateway.err.log`ï¼ˆé»˜è®¤ï¼š`~/.OpenKrab/logs/...`ï¼›é…ç½®æ–‡ä»¶ä½¿ç”¨ `~/.OpenKrab-<profile>/logs/...`ï¼‰
- Linuxï¼š`journalctl --user -u OpenKrab-gateway[-<profile>].service -n 200 --no-pager`
- Windowsï¼š`schtasks /Query /TN "OpenKrab Gateway ç½‘å…³ (<profile>)" /V /FO LIST`
...
å¦‚æžœä½ æ‰‹åŠ¨è¿è¡Œ Gateway ç½‘å…³ï¼Œ`OpenKrab gateway --force` å¯ä»¥å›žæ”¶ç«¯å£ã€‚å‚é˜… [Gateway ç½‘å…³](/gateway)ã€‚

### æˆ‘åœ¨ Windows ä¸Šå…³é—­äº†ç»ˆç«¯â€”â€”å¦‚ä½•é‡å¯ OpenKrab
...
1. Gateway ç½‘å…³åœ¨è¿è¡Œå—ï¼Ÿ`OpenKrab gateway status`
2. Gateway ç½‘å…³å¥åº·å—ï¼Ÿ`OpenKrab status`
3. UI æœ‰æ­£ç¡®çš„ä»¤ç‰Œå—ï¼Ÿ`OpenKrab dashboard`
...
### é€šä¿—è§£é‡Šï¼šOpenKrab gateway restart ä¸Ž OpenKrab gateway

- `OpenKrab gateway restart`ï¼šé‡å¯**åŽå°æœåŠ¡**ï¼ˆlaunchd/systemdï¼‰ã€‚
- `OpenKrab gateway`ï¼šåœ¨è¿™ä¸ªç»ˆç«¯ä¼šè¯ä¸­**å‰å°**è¿è¡Œ Gateway ç½‘å…³ã€‚

å¦‚æžœä½ å®‰è£…äº†æœåŠ¡ï¼Œä½¿ç”¨ Gateway ç½‘å…³å‘½ä»¤ã€‚æƒ³è¦ä¸€æ¬¡æ€§å‰å°è¿è¡Œæ—¶ä½¿ç”¨ `OpenKrab gateway`ã€‚
...
æ™ºèƒ½ä½“çš„å‡ºç«™é™„ä»¶å¿…é¡»åŒ…å« `MEDIA:<path-or-url>` è¡Œï¼ˆç‹¬å ä¸€è¡Œï¼‰ã€‚å‚é˜… [OpenKrab åŠ©æ‰‹è®¾ç½®](/start/OpenKrab)å’Œ [Agent send](/tools/agent-send)ã€‚
...
### å°† OpenKrab æš´éœ²ç»™å…¥ç«™ç§ä¿¡å®‰å…¨å—
...
- æ”¯æŒç§ä¿¡çš„æ¸ é“ä¸Šçš„é»˜è®¤è¡Œä¸ºæ˜¯**é…å¯¹**ï¼š
  ...
  - æ‰¹å‡†æ–¹å¼ï¼š`OpenKrab pairing approve <channel> <code>`
  - æ¯ä¸ªæ¸ é“çš„å¾…å¤„ç†è¯·æ±‚ä¸Šé™ä¸º **3 ä¸ª**ï¼›å¦‚æžœæ²¡æ”¶åˆ°ä»£ç ï¼Œæ£€æŸ¥ `OpenKrab pairing list <channel>`ã€‚
- å…¬å¼€å¼€æ”¾ç§ä¿¡éœ€è¦æ˜Žç¡®é€‰æ‹©åŠ å…¥ï¼ˆ`dmPolicy: "open"` ä¸”å…è®¸åˆ—è¡¨ `"*"`ï¼‰ã€‚

è¿è¡Œ `OpenKrab doctor` ä»¥å‘çŽ°æœ‰é£Žé™©çš„ç§ä¿¡ç­–ç•¥ã€‚
...
ä¸ä¼šã€‚WhatsApp çš„é»˜è®¤ç§ä¿¡ç­–ç•¥æ˜¯**é…å¯¹**ã€‚æœªçŸ¥å‘é€è€…åªä¼šæ”¶åˆ°é…å¯¹ç ï¼Œä»–ä»¬çš„æ¶ˆæ¯**ä¸ä¼šè¢«å¤„ç†**ã€‚OpenKrab åªå›žå¤å®ƒæ”¶åˆ°çš„èŠå¤©æˆ–ä½ æ˜Žç¡®è§¦å‘çš„å‘é€ã€‚
...
OpenKrab é»˜è®¤é˜»æ­¢**è·¨æä¾›å•†**æ¶ˆæ¯ã€‚å¦‚æžœå·¥å…·è°ƒç”¨ç»‘å®šåˆ° Telegramï¼Œé™¤éžä½ æ˜Žç¡®å…è®¸ï¼Œå¦åˆ™ä¸ä¼šå‘é€åˆ° Discordã€‚
...
**ç­”ï¼š** åœ¨ OpenKrab ä¸­ï¼Œå‡­æ®å’Œæ¨¡åž‹é€‰æ‹©æ˜¯åˆ†å¼€çš„ã€‚è®¾ç½® `ANTHROPIC_API_KEY`ï¼ˆæˆ–åœ¨è®¤è¯é…ç½®æ–‡ä»¶ä¸­å­˜å‚¨ Anthropic API å¯†é’¥ï¼‰å¯ç”¨è®¤è¯ï¼Œä½†å®žé™…çš„é»˜è®¤æ¨¡åž‹æ˜¯ä½ åœ¨ `agents.defaults.model.primary` ä¸­é…ç½®çš„ï¼ˆä¾‹å¦‚ `anthropic/claude-sonnet-4-5` æˆ– `anthropic/claude-opus-4-5`ï¼‰ã€‚å¦‚æžœä½ çœ‹åˆ° `No credentials found for profile "anthropic:default"`ï¼Œæ„å‘³ç€ Gateway ç½‘å…³åœ¨æ­£åœ¨è¿è¡Œçš„æ™ºèƒ½ä½“çš„é¢„æœŸ `auth-profiles.json` ä¸­æ‰¾ä¸åˆ° Anthropic å‡­æ®ã€‚

---

ä»ç„¶å¡ä½ï¼Ÿåœ¨ [Discord](https://discord.com/invite/Krabd) ä¸­æé—®æˆ–å‘èµ· [GitHub è®¨è®º](https://github.com/OpenKrab/OpenKrab/discussions)ã€‚
