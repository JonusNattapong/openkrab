...
将 OpenKrab 部署到生产服务器的推荐方式是通过 **[OpenKrab-ansible](https://github.com/OpenKrab/OpenKrab-ansible)** — 一个安全优先架构的自动化安装程序。
...
> **📦 完整指南：[github.com/OpenKrab/OpenKrab-ansible](https://github.com/OpenKrab/OpenKrab-ansible)**
>
> OpenKrab-ansible 仓库是 Ansible 部署的权威来源。本页是快速概述。
...
# 或直接运行（然后手动执行 /tmp/OpenKrab-setup.sh）
...
- [安全架构](https://github.com/OpenKrab/OpenKrab-ansible/blob/main/docs/security.md)
- [技术详情](https://github.com/OpenKrab/OpenKrab-ansible/blob/main/docs/architecture.md)
- [故障排除指南](https://github.com/OpenKrab/OpenKrab-ansible/blob/main/docs/troubleshooting.md)

## 相关内容

- [OpenKrab-ansible](https://github.com/OpenKrab/OpenKrab-ansible) — 完整部署指南
