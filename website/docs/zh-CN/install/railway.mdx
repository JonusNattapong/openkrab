...
- `https://<your-railway-domain>/OpenKrab` — 控制面板 UI
...
- `OPENKRAB_STATE_DIR=/data/.OpenKrab`（推荐）
- `OPENKRAB_WORKSPACE_DIR=/data/workspace`（推荐）
- `OPENKRAB_GATEWAY_TOKEN`（推荐；请视为管理员密钥）
