...
- `OpenKrab browser download e12 /tmp/report.pdf`
- `OpenKrab browser waitfordownload /tmp/report.pdf`
- `OpenKrab browser upload /tmp/file.pdf`
...
- `OpenKrab browser set headers --json '{"X-Debug":"1"}'`
