...
Skills 位于你的工作区中，通常是 `~/.OpenKrab/workspace/skills/`。为你的 Skill 创建一个新文件夹：
...
- **本地测试**：使用 `OpenKrab agent --message "use my new skill"` 进行测试。

## 共享 Skills

你也可以在 [KrabHub](https://KrabHub.com) 上浏览和贡献 Skills。
